...
<section class="w3l-about-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>Programs</h2>
      <p><a href="index12.php">Home</a> &nbsp; / &nbsp; Programs</p>
    </div>
  </div>
</section>
        ...
        <div class="container py-md-5">
            <div class="cwp4-two row">
                ...
                <div class="cwp4-text col-lg-8">
                        <h3 style="color:#1090CD; font-size:30px">Academic Programs</h3>
                        <h5 style="color:#5B8343 ; font-weight:bold;">Undergraduate Programs</h5>
                        <br>
                        <h6 style="font-size:15px">Following is the list of undergraduate programs offered by the computer Science & It department</h6>
                        <ul style="margin-left: 40px;">
                         <a href="ds.php"> <li> Bachelor of Science in Data Science</li></a>
                           <a href="undergaraduate.php">  <li> Bachelor of Science in Computer Science</li></a>
                  </ul>
                      <h5 style="color:#5B8343; font-weight:bold;">Graduate Programs</h5>
                        <br>
                        <h6 style="font-size:15px">Following is the list of Graduate programs offered by the computer Science & It department</h6>
                        <ul style="margin-left: 40px;">
                         
                           <a href="bs.php">  <li> Masters of Science in Computer Science</li></a>
                  </ul>
                  <h5 style="color:#5B8343; font-weight:bold;">BIOPS</h5>
                  <?php
                 $sql = "SELECT * FROM biops ";
$result = $conn->query($sql);
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
      $v8=$row['file'];
     $file="../html/ltr/vertical-menu-template/uploads/$v8";
    echo " 
     <ul style='margin-left: 40px';>   
                           <a href='$file' style='font-weight: bold;'>  <li> BIOP Of session $row[session]</li></a>
