...
<section class="w3l-about-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>Our Vision</h2>
      <p><a href="index12.php">Home</a> &nbsp; / &nbsp; Vision</p>
    </div>
  </div>
</section>
        ...
        <div class="container py-md-5">
            <div class="cwp4-two row">
                    ...
                    <div class="cwp4-text col-lg-8">
                        <h3 style="color:#1090CD; font-size:25px">Our Vision</h3>
                        <h6 style="color:#5B8343">Welcome to CS&IT Department of WUBAJK</h6>
                    <p style="font-size:16px">To excel in teaching, research and services that advance the economic strength of the region, state, nation and beyond through women empowerment in the field of computing. We aim to produce graduates, who will be able to bring technical ethical and life-long learning skills to the computer science profession.
