   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
    ...
    <div class="row">
        <div class="col-12">
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#1090CD;color: white ">ID</th>
                                    ...
                                    <th style="background-color:#1090CD;color: white  ">HeadName</th>
            ...
            $sql = "SELECT headname,category,id FROM employeeheads order by category ";
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Delete Selected Employee Head?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
 .then((willDelete) => {
  if (willDelete) {
     $.ajax({
                url:"deleteemployee.php?id="+del_id,
                cache:false,
