...
if ($rowadv['pagename']=='Delete Fee')
{
   ...
   echo "<li class='active'><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
	...
	<div class="row">
		<div class="col-md-6">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Welcome to Delete Fee</h4>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="viewfees">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-money"></i> Report Requirments</h4>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label style="color:black" for="projectinput1">Select Month</label>
     ...
     id="date" class="form-control">
                  ...
                  $query="SELECT DISTINCT feeperiod from fees";
        ...
        $conn->close();
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-check-square-o"></i> View Fee Bills 
                </button>
              ...
              <div  class="form-actions right">
                 <button type="submit"  id="save3" class="btn btn-danger btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-check-square-o"></i> Delete All School Fee Bills
                </button>
      ...
      <div class="card">
        <div style="background-color: #f9d140"  class="card-header">
          <h4 class="card-title" id="basic-layout-colored-form-control">Delete Class Fee Bills</h4>
          <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
          <div class="heading-elements">
            <ul class="list-inline mb-0">
          ...
          <div class="card-body">
              ...
              <div class="form-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label style="color: black" for="userinput1">Select Class</label>
                    <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;"  id="curr_class" required="" name="curr_class" class="form-control">
            ...
            ?>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label style="color:black" for="userinput2">Select Month</label>
            <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;"  name="monthname" id="month" required="" class="form-control" >
                     </select>
                    </div>
                  </div>
 ...
 <br>
  <hr>
              ...
              <div class="form-actions right">
                 <button  type="submit"  id="save2" class="btn btn-warning btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-check-square-o"></i> Delete Class Fee Bills
                </button>
