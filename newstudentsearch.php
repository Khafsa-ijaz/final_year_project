    ...
    <div class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Search Students</h4>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="viewsimilarstudents.php">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-clock-o"></i> Search Students</h4>
                <div class="row">
               
                  <div class="col-md-12">
                    <div class="form-group">
        <label style="color:black" for="projectinput2">Search  by Name</label>
                        <input style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;" type="text" id="name"   class="form-control" placeholder="" name="name">
                    </div>
                  </div>
                </div>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" class="btn btn-info-outline btn-min-width btn-glow mr-1 mb-1" style="background-color:#5B8343; color: white;">
                  <i class="fa fa-get-pocket"></i> Search
                </button>
              </div>
            </form>
