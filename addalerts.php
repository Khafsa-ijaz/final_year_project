...
echo '</script>';
      ...
      $sql = "INSERT INTO alert(fname,file, date)
VALUES ('$fname', '$file','$date')";
if ($conn->query($sql) === TRUE) {
  echo '<script type="text/javascript">';
  echo 'setTimeout(function () { swal("SUCCESS","Alert Uploaded Successfully!","success");';
  echo '}, 500);</script>';
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Add Alert Form</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Alert  <span style="color:red">*</span> </label>
                    ...
                    <div  style="display: none" class="loader"></div>
                            ...
                            <div class="form-actions">
                                ...
                                <button  name="submit" style="background-color: #5B8343;color:white;border:1px solid #062F4F" type="submit" class="btn btn-outline-info ">
                                    <i class="fa fa-check"></i> Add Alert
                                </button>
                            </div>
                            </form>
