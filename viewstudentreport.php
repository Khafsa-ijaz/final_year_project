...
#myDiv {
  ...
  text-align: center;
    ...
    <title>Students Reports Area</title>
...
else
{
  ...
  <div class="row">
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Students Reports Section</h4>
    ...
    <div class="col-md-12">
     ...
     <div class='col-md-4'>
                                            <li ><a style='' href='allstudentsreport.php'><i class='fa fa-file-text-o'></i> MS Students Report</a></li>
            </div>
                 ...
                 <div class='col-md-4'>
                          <li ><a style='' href='bsstudentsreport.php'><i class='fa fa-file-text-o'></i> BSCS Students Report</a></li>
              </div>
                  ...
                  <div class='col-md-4'>
                        <li ><a style='' href='dsstudentreport.php'><i class='fa fa-file-text-o'></i>
                                BSDS Students Report</a></li>
                                </div>
  ...
  <?php
                        include('config.php');
                $department_query = "SELECT DISTINCT headname FROM employeeheads where category='department'";
