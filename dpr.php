...
<html class="loading" lang="en" data-textdirection="ltr">
 <head>
  ...
  <meta name="description" content="School Management System developed by Pak Softwares. The system provides the best and easy solution to handle school matters including admissions, fees, accounts, examination, sms, website controls, portal controls and many more.">
    ...
    <title>Datewise Patients Record</title>
    ...
    <div class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Datewis Patients Record</h4>
            ...
            <form target="_blank" class="form" method="POST" action="dpr2.php">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-user"></i> Report Requirments</h4>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="projectinput2">Select Date</label>
                        <div class="col-md-6">
                    <div class="form-group">
                 ...
                 <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="date" id="date"  class="form-control" placeholder="" value="<?php echo date("Y-m-d")?>" name="date1">
                    </div>
                  </div>
                    </div>
                  </div>
              ...
              <div class="form-actions ">
                 <button tyle="background-color: #ffd338;color:black
                  ...
                  <i class="fa fa-check-square-o"></i> View Datewise Patients Record
                </button>
