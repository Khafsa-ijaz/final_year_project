		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Add Employees Salary Details</h4>
...
<a data-toggle='tooltip' title='Add Salary Details' href=sa.php?id=".$row['id']."> <button type='button' class='btn btn-icon btn-success btn-sm'><i class='fa fa-money'></i></button></a>
