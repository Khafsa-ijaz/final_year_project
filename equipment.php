...
#myDiv {
  ...
  text-align: center;
    ...
    <title>Add Lab Equipment Form</title>
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Welcome to Add New Lab Equipment  Form</h4>
            ...
            <div class="s text-center " role="" aria-label="Basic example">   <button type="button" class="btn btn-info btn-sm btn-glow" data-toggle="modal" data-target="#flipInY">
                    ...
                    <div class="modal-content">
                      ...
                      <h5>Add Your Equipment</h5>
                      <p>Add Your Test Equipment</p>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" autofocus="true" placeholder="" id="name" name="name">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label style="color:black" class="col-md-3 label-control" for="userinput1">QTY (STARTING)</label>
                                  <div class="col-md-9">
...
if ($result22->num_rows > 0) {
  ...
  <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <textarea style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;height:100px" type="text"  class="form-control" value=""  placeholder="" id="location" name="location"></textarea>
                                    </div>
                                </div>
                            </div>
