...
$sql3 = "UPDATE fview SET status='$status[$i]' WHERE id='$id[$i]' and emp='$id2'";
...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                ...
                <h4 style='color:white' class="card-title">Assign Edit / Delete Username <b><u><?php echo $id2?></b></u> <b><i style="color:red"></i><u></u></b></h4>
  ...
  $count=0;
            include('connection.php');
$sql6 = "SELECT * FROM fview where emp='$id2' order by id ASC";
 ...
 <option  value='0'> Hide </option>
  <option value='1'> Show </option>
           ...
           ?>
                 ...
                 <p align="center"><button type="submit" class="btn btn-info" name="save">Assign Edit / Delete</button></p>
              </form>
            </div>
        </div>
    </div>
