...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <meta name="description" content="School Management System developed by Pak Softwares. The system provides the best and easy solution to handle school matters including admissions, fees, accounts, examination, sms, website controls, portal controls and many more.">
    ...
    <title>View Installment Plan</title>
...
if ($rowadv['pagename']=='View Installment Plan')
{
    ...
    <div style='display:none' class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">View Installment Play</h4>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="assignpaymentplan2.php">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-tasks"></i> Tasks Requirement</h4>
                <div class="row">
               
                   <div style='display:none' class="col-md-6">
                    <div class="form-group">
                      <label for="projectinput1">Select Project</label>
 <select s style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white" type="text" id="pr" autofocus="true" class="form-control" value="" name="name">
                                                <?php
                        include('config.php');
                $department_query = "SELECT * FROM pr where type='Multi Storey Building' order by id DESC";
            ...
            ?>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"   class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-get-pocket"></i> Assign Payment Plan
                </button>
              </div></form>
    ...
    <div class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">View Installment Plan</h4>
                  <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
              <div class="heading-elements">
                      <ul class="list-inline mb-0">
                        <li style="color:white"><a data-action="collapse"><i class="ft-minus"></i></a></li>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="pr2.php">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-tasks"></i> Tasks Requirement</h4>
                <div class="row">
                   ...
                   <div class="col-md-12">
                    <div class="form-group">
                      <label for="projectinput1">CNIC No</label>
 <input s style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white" type="text" id="pr" autofocus="true" class="form-control" value="" name="cnic">
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"   class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-get-pocket"></i> View Installment Plan
                </button>
              </div></form>
...
console.log(cc);
 swal({
  title: "Are you sure to Delete Selected Day Task?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
     ...
     $.ajax({
              ...
              //  dataType: 'json',
                success:function(result){
                    console.log(result);
                   swal("All Selected Day Task Deleted Successfully",{icon: "success"});
