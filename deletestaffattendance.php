...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Delete Staff Attendance</title>
...
if ($rowadv['pagename']=='Delete Attendance')
{
    ...
    <div class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Delete Staff Attendance</h4>
          ...
          <div class="card-body">
            ...
            <form class="form">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-trash"></i> Delete Requirement</h4>
                <div class="row">
               
                  <div class="col-md-12">
                    <div class="form-group">
        <label style="color:black" for="projectinput2">Select Date</label>
                        <input style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;" type="date" id="dateid"value="<?php echo date("Y-m-d")?>"  class="form-control" placeholder="" name="date">
                    </div>
                  </div>
                </div>
...
<hr>
              <div class="form-actions">
                      ...
                      <button type='submit'  id='save' class='btn btn-info-outline cc btn-min-width btn-glow mr-1 mb-1' style="background-color:#5B8343; color: white;">
                  <i class='fa fa-get-pocket '></i> Delete All Staff Attendance 
                </button>
 ...
 <div class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Delete Single Staff Attendance</h4>
                  <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
              <div class="heading-elements">
                      <ul class="list-inline mb-0">
                        <li style="color:white"><a data-action="collapse"><i class="ft-minus"></i></a></li>
        ...
        <label style="color:black" for="projectinput2">Select Date</label>
                  ...
                  <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;"  type="text" id="id" autofocus="true" class="form-control" value="" name="id">
                                       <?php
                        include('config.php');
...
<hr>
              <div class="form-actions">
                                ...
                                <button type='submit'  id='save' class='btn btn-info-outline cc2 btn-min-width btn-glow mr-1 mb-1' style="background-color:#5B8343; color:white">
                  <i class='fa fa-get-pocket'></i> Delete Single Staff Attendance 
                </button>";
...
console.log(cc);
 swal({
  title: "Are you sure to Delete Staff Attendance?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
     ...
     $.ajax({
              ...
              //  dataType: 'json',
                success:function(result){
                    console.log(result);
                   swal("All Staff Attendance Deleted Successfully",{icon: "success"});
...
console.log(id);
 swal({
  title: "Are you sure to Delete Single Staff Attendance?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
     ...
     $.ajax({
              ...
              //  dataType: 'json',
                success:function(result){
                    ...
                    swal({
    title: 'Delete Alert.....!',
    text: 'Single Staff Attendance Deleted',
    type: 'success',
    timer: 2500,
