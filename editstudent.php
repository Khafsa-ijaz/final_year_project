...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    $userid = $_GET['id'];
echo "<input type='hidden' id='nus' value=$userid />";

    $get_user = mysqli_query($conn,"SELECT * FROM students WHERE id='$userid'");
...
if(isset($_POST['submit']))
  {
     ...
     $address=$_POST['address'];
      ...
      $query = "SELECT regno,rollno from students  where  id !='$userid' AND regno='$regno' AND rollno='$rollno' ";
$resultlite = mysqli_query($conn,$query);

if(mysqli_num_rows($resultlite) > 0)
{
   header("Location:viewstudents1.php");
     ob_end_flush();
}
 else
 {   
     ...
     $sql ="update students set sname='$name',fname='$fathername',gender='$gender',nic='$fnic',occupation='$foccupation',phone='$ph',mob='$mob',curr_class='$class',regno='$regno',rollno='$rollno',monfee='$monthlyfee',newfee='$newfee',lunchfee='$lunchfee',tfee='$tfee',bdate='$dob',admdate='$admdate',status='$status',snic='$snic',mob1='$mob1',mob2='$mob2',paddress='$paddress',address='$address' where id='$userid'";
...
else
{
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Welcome to Edit Student Form</h4>
    ...
    <a target="_blank" href="viewstudents"><button type="button"  class="btn btn-warning btn-sm btn-glow" >Students List</button>
        <button type="button"  class="btn btn-success btn-sm btn-glow" >Sample Excel Format</button></a>
                    ...
                    <div class="modal-content">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" placeholder="" autofocus="true" value="<?php echo $roww['sname']?>" id="sname" name="sname">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" placeholder="" value="<?php echo $roww['fname']?>" id="fname" name="fname">
                                    </div>
                                </div>
                            </div>
                              <div class="col-md-6">
                      ...
                      <option value="<?php echo $roww['gender']?>"><?php echo $roww['gender']?></option>
                        ...
                        <option value="Female">Female</option>
                              ...
                              <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="date" class="form-control" id="bdate" placeholder="" value="<?php echo $roww['bdate']?>" name="bdate">
                                    </div>
                                </div>
                            </div>
                             ...
                             <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                  <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text" class="form-control" value="<?php echo $roww['address']?>" id="address" placeholder="" name="address">
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-md-6">
                                ...
                                <label style="color:black" class="col-md-3 label-control" for="userinput1">Permanant Address</label>
                                  <div class="col-md-9">
                                         <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;"  type="text" class="form-control" value="<?php echo $roww['paddress']?>" id="paddress" placeholder="" name="paddress">
                                    </div>
                                </div>
                            </div>
                              <div class="col-md-6">
                             ...
                             <label style="color:black" class="col-md-3 label-control" for="userinput1">Student NIC</label>
                                  <div class="col-md-9">
                                        <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" class="form-control" value="0" value="<?php echo $roww['snic']?>" id="snic" placeholder="" name="snic">
                                    </div>
                                </div>
                            </div>
                              <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" class="form-control" value="<?php echo $roww['mob1']?>" maxlength="12" value="92" id="mob1" placeholder="" name="mob1">
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                         <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" class="form-control" value="<?php echo $roww['mob2']?>" maxlength="12" value="92" id="mob2" placeholder="" name="mob2">
                                    </div>
                                </div>
                            </div>
</div>
  ...
  <h4 class="form-section" style="color: black" ><i class="ft-user"></i> Father/Guardian Info</h4>
                    ...
                    <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" id="nic" class="form-control border-primary" value="<?php echo $roww['nic']?>" placeholder="" name="fnic">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text" id="occupation" class="form-control border-primary" placeholder="" value="<?php echo $roww['occupation']?>" name="foccupation">
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" id="phone" value="<?php echo $roww['phone']?>"  maxlength="9" class="form-control border-primary" placeholder="" name="ph">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" id="mob" maxlength="12" value="<?php echo $roww['mob']?>" class="form-control border-primary" value="92" placeholder="" name="mob">
                                  </div>
                                </div>
                              </div>
        ...
        include('connection.php');
                      $id=$roww['curr_class'];
$sql = "SELECT cname FROM classes where id='$id'";
...
?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                 <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" id="curr_class" name="class" class="form-control">
                        <option value="<?php echo $roww['curr_class']?>"><?php echo $cname?></option>
                      <?php
                        include('config.php');
                $department_query = "SELECT * FROM classes  where id!='$id'";
                $stmt = $conn->prepare($department_query);
                $stmt->execute();
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                echo "<option value='".$row['id']."''>".$row['cname']."</option>";
            ...
            ?>  </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" id="regno" class="form-control border-primary" placeholder="" value="<?php echo $roww['regno']?>" name="regno">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;"type="number" id="rollno" class="form-control border-primary" value="<?php echo $roww['rollno']?>"  placeholder="" name="rollno">
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" id="monfee" readonly="" value="<?php echo $roww['monfee']?>" class="form-control border-primary" placeholder="" name="monthlyfee">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" id="newfee" value="<?php echo $roww['newfee']?>"  class="form-control border-primary" value="0" placeholder="" name="newfee">
                                  </div>
                                </div>
                              </div>
 ...
 <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" value="<?php echo $roww['tfee']?>" id="tfee" class="form-control border-primary" placeholder="" name="tfee">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number" value="<?php echo $roww['lunchfee']?>" id="lunchfee" class="form-control border-primary" placeholder="" name="lunchfee">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="date" id="admdate" value="<?php echo $roww['admdate']?>" class="form-control border-primary"  placeholder="" name="admissiondate">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
if ($roww['status']=='Active')
{
  echo "       <option value='In-Active'>In-Active</option>";
}                   


if ($roww['status']=='In-Active')
{
...
if (newfee=='')
{
 ...
 $.ajax({
                  ...
                  curr_class:curr_class,regno:regno,rollno:rollno,monfee:monfee,newfee:newfee,tfee:tfee,lunchfee:lunchfee,admdate:admdate,status:status},
