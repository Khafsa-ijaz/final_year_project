...
if ($rowadv['pagename']=='Add Notification')
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Add New Notification Form</h4>
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                       ...
                       <form class="form" method="POST">
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i> Notification Info</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Notification Title <span style="color:red">*</span> </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;border:1px solid #5B8343"  type="text" id="title" autofocus="true" class="form-control" value="" name="username">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Writer Name <span style="color:red">*</span> </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="name" value="" autofocus="true" class="form-control" value="" name="username" placeholder="Notify By">
                                        </div>
 </div>
                                       ...
                                       <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="projectinput1">Add Notification <span style="color:red">*</span> </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="notice" value="" autofocus="true" class="form-control" value="" name="username">
                                        </div>
 </div>
                    ...
                    <div  style="display: none" class="loader"></div>
                            ...
                            <div class="form-actions">
                                ...
                                <button id="save" name="submit" style="background-color: #5B8343;color:white;border:1px solid #062F4F" type="submit" class="btn btn-outline-info ">
                                    <i class="fa fa-check"></i> Upload Notification
                                </button>
                            </div>
...
if (name!='' )
{
 $.ajax({
                  type:'POST',
                    url: 'savenotifications.php',
                    dataType: 'json',
                    data: {name:name,title:title,notice:notice},
