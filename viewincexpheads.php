...
else
{
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                      ...
                      <h4 class="card-title">Income Expense Heads List</h4>
  ...
  $count=0;
   ...
   $sql = "SELECT DISTINCT iname,type,id FROM income where type='Income' or type='Expnse' ";
...
dom: 'Blfrtip',
...

        {
           extend: 'csv',
           footer: false,
                   messageTop: 'Income Expense Heads List'
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Delete Head?All Transactions in this head will be DELETED also,Be Carefull",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
