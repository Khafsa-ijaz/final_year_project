    ...
    <div style="background-color: #1090CD" class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li style="background-color: #1090CD" class=" navigation-header"><span data-i18n="nav.category.layouts">RAHMA ISLAMIC</span><i class="ft-more-horizontal ft-minus" data-toggle="tooltip" data-placement="right" data-original-title="Layouts"></i>
          </li>
...
if ($rowadv['pagename']=='Bills History')
{
  ...
  <div class="row">
   ...
   <a href="ltr10.php"> <button type="button"  class="btn btn-success btn-sm btn-glow" >National Stock Expense Report</button></a>
   
 
   <a href="ltr11.php"> <button type="button"  class="btn btn-warning btn-sm btn-glow" >Multi-National Stock Expense Report</button></a>
   
      <a href="ltr12.php"> <button type="button"  class="btn btn-info btn-sm btn-glow" >DHO Stock Expense Report</button></a>
      
      
      <a href="nmc.php"> <button type="button"  class="btn btn-primary btn-sm btn-glow" >National Medicine Catalog</button></a>
