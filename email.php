...
$sql = "SELECT email FROM extrastudents where session='$session' ";
}
...
$sql = "SELECT email FROM students where session='$session' and program='BSCS'";
}
if ($sendto=='BSDS')
...
$sql = "SELECT email FROM students where session='$session' and program='BSDS'";
}
if($sendto=='All')
{
  $sql ="SELECT email FROM students
UNION
SELECT email FROM extrastudents;";
}
...
$mail->Body = $message;
  ...
  echo 'setTimeout(function () { swal("SUCCESS","Emails Send Successfully!","success");';
  echo '}, 1000);</script>';
  }
  else
  {
...
include('navigation.php');
 ...
 <?php include('fourteen.php');
    ...
    ?>
          ...
          <li  class=" nav-item"><a href="#"><i class="icon-layers"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Email Section</span></a>
            <ul class="menu-content">


   <?php
                $sqladv = "SELECT pagename,link FROM menu where category='Email Section' and status='1' and user='$rowsession[username]'";
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Send Email Form</h4>
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                       ...
                       <form class="form" method="POST">
                            <div class="form-body">
                                <h4 class="form-section"><i class="fa fa-envelope"></i> Email Info</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Send To <span style="color:red">*</span> </label>
                                         
                                            <select  style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;border:1px solid #5B8343"  type="text" id="sendto" autofocus="true" class="form-control" value="" name="sendto">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select  style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;border:1px solid #5B8343"  type="text" id="session" autofocus="true" class="form-control" value="" name="session">
                                              
                                                        <?php

include('connection.php');
                          $sql = "SELECT DISTINCT session FROM students";
$result = $conn->query($sql);
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
   ...
   echo "<option value='".$row['session']."''>".$row['session']."</option>";
                                       ...
                                       <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="projectinput1">Type Email <span style="color:red">*</span> </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="mail" value="" autofocus="true" class="form-control" value="" name="mail">
                                        </div>
 </div>
