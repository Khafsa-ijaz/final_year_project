...
if ($rowadv['pagename']=='Subject Result Sheet')
{
...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Subject Result Sheet</h4>
         ...
         <form  target="_blank" class="form form-horizontal" method="POST" action="pdfsubjectsheet">              <div class="form-body">
  ...
  ?>
                ...
                <button name="submit"    type="submit" value=""  class="btn btn-warning btn-min-width btn-glow mr-1 mb-1" />Subject Result Sheet</button> 
                </form>
