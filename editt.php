...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $userid = $_GET['id'];
    $get_user = mysqli_query($conn,"SELECT * FROM income WHERE id='$userid'");
...
$byy=$rowsession['username'];
       $sql ="update income set descrip='$descrip',date='$date',amountin='$amountin',datetimee='$d',byy='$byy' where id='$userid'
     ...
     ";
      if ($conn->query($sql) === TRUE) {
       ...
       $sql2 ="update banks set descrip='$descrip',date='$date',amountin='$amountin',datetimee='$d',byy='$byy' where id='$tcode' and source='$source'

     ";
      if ($conn->query($sql2) === TRUE) {
            header("Location:incomeexpenseledger");
    ob_end_flush();
    exit();
      }
...
if ($rowadv['pagename']=='Make Expense')
{
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Edit Transaction <?php echo $roww['iname']?></h4>
            ...
            <div class="s text-center " role="" aria-label="Basic example">   
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                        ...
                        <div class="form-body">
                          ...
                          <div class="row">
                               ...
                               <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" value="<?php echo $roww['iname']?>" type="hidden"  id="iname" class="form-control" placeholder=""  name="source">
                        
                           <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" value="<?php echo $roww['tcode']?>" type="hidden"  id="iname" class="form-control" placeholder=""  name="tcode">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      <label style="color:black" for="projectinput1"><b>Credit</b></label>
                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="number"  id="ob" value="<?php echo $roww['amountin']?>" class="form-control" placeholder="" name="amountin">
                    </div>
                  </div>
