...
if ($rowadv['pagename']=='Mark Attendance')
{
    ...
    <div class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">All Staff Attendance</h4>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="markstaff">
              <div class="form-body">
        ...
        <label style="color:black" for="projectinput2">Select Date</label>
                        <input style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;" type="date" id="date" value="<?php echo date("Y-m-d")?>"  class="form-control" placeholder="" name="date">
                    </div>
                  </div>
                </div>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" class="btn btn-info-outline btn-min-width btn-glow mr-1 mb-1" style="background-color:#5B8343; color: white;">
                  <i class="fa fa-get-pocket"></i> Mark Staff Attendance 
                </button>
              </div>
            </form>
