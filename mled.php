...
if ($rowadv['pagename']=='Stock IN/OUT Report')
{
		...
		<div class="col-md-6">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Vendor Ledger</h4>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="idetail2.php">
              <div class="form-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label style="color:black" for="projectinput1">Medicine Barcode</label>
                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text" id="bcode"  class="form-control" placeholder="" value="" name="bcode">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label style="color:black" for="projectinput1">Select Type</label>
                        <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;"  id="type"  required=""   name="type"  class="form-control">
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" class="btn btn-success btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-get-pocket"></i> View Medicine Report
                </button>
              </div>
            </form>
