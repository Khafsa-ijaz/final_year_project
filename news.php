...
<section class="w3l-features-8">
      ...
      <div class="container py-md-3">
            ...
            <h2 style="color: #1090CD; font-weight: bold;"> News Area</h2>
            <br>
...
if ($result->num_rows > 0) {
 ...
 $date = $row['date'];
  ...
  $a1=date("M",strtotime($date));
      ...
      $format=$a3." ".$a1." ".$a2;
   $limitedText = substr($row['txt'], 0, 100);

echo"
   <div class='float-top col-lg-4 col-md-6 mt-md-0 mt-5'>  
              <a href='galldet.php?id=$row[id]'><img src='$image'  class='img-fluid' alt='' style='width:300px; height:40%'></a>
              <div class='float-lt feature-gd'> 

                  <h3><a href='galldet.php?id=$row[id]'>$row[fname]</a> </h3>
                  <p>      
...
<a href='galldet.php?id=$row[id]' style='color:#1090CD'>FULL STORY-></a> 
</div>
            </div>
