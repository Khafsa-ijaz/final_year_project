...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <meta name="description" content="School Management System developed by Pak Softwares. The system provides the best and easy solution to handle school matters including admissions, fees, accounts, examination, sms, website controls, portal controls and many more.">
    ...
    <title>Installment Defaulters Report</title>
...
if ($rowadv['pagename']=='Defaulters Report')
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Defaulters Report</h4>
            ...
            <form class="form" method="POST" action="dapdf.php">
              <div class="form-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="month" id="date1" name="month" value="<?php echo date("Y-m")?>" class="form-control border-primary" placeholder="Name" >
                    </div>
                  </div>
              ...
              <div class="form-actions ">
                 <button tyle="background-color: #ffd338;color:black
                  ...
                  <i class="fa fa-check-square-o"></i> View Defaulters Report
                </button>
