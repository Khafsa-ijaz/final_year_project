...
if ($rowadv['pagename']=='Class Report')
{
...
else
{
  ...
  <?php
      ...
      ?>
                      <h4 class="card-title">Class Attendance List  <b><i style="color:red">From Date: </i><u><?php echo $date?></u><i style="color:red">To Date: </i><u><?php echo $date1?></u> <i style="color:green">Class: </i><u><?php echo $cc?></u></b></h4>
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                 ...
                 <div class="s text-center " role="" aria-label="Basic example"> 
                      <form method="POST" action="pdfclassattendance">
  ...
  $count=0;
   ...
   $sqli = "SELECT regno,date,status FROM attendence where class='$curr_class' and date BETWEEN '$date' and '$date1' and session='$session' order by date  ";
            ...
            // output data of each row
             while($row = mysqli_fetch_assoc($result))  {
              ...
              $query2="SELECT sname FROM students where regno='$regno' and session='$session'";
...
dom: 'Blfrtip',
...

        {
           extend: 'csv',
           footer: false,
                messageTop: '   Class Attendance Chart of <?php echo $cc;?>From: <?php echo $format?> TO: <?php echo $format1?>'
