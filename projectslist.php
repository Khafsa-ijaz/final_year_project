   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
    ...
    <div class="row">
        <div class="col-12">
            ...
            $sql = "SELECT headname,id FROM projects  ";
...
";           
         ...
         $sql12 = "SELECT * FROM fview where emp='$rowsession[username]'  and fname='Delete Projects' and status='1'";
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Delete Selected Project?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
