...
if ($rowadv['pagename']=='Bills History')
{
  ...
  <div class="row">
   ...
   <a href="ltr.php"> <button type="button"  class="btn btn-success btn-sm btn-glow" >Monthly PAID Lab Test Report</button></a>


      <a href="delaya.php"> <button type="button"  class="btn btn-success btn-sm btn-glow" >Annual PAID Lab Test Report</button></a>
   
     <a href="ltr3.php"> <button type="button"  class="btn btn-warning btn-sm btn-glow" >Monthly FREE Lab Test Report</button></a>
   


  <a href="delayb.php"> <button type="button"  class="btn btn-warning btn-sm btn-glow" >Annual FREE Lab Test Report</button></a>



     <a href="ltr2.php"> <button type="button"  class="btn btn-info btn-sm btn-glow" >Monthly Self Lab Test Report</button></a>
     

          <a href="delayc.php"> <button type="button"  class="btn btn-info btn-sm btn-glow" >Annual Self Lab Test Report</button></a>
     
    
      
          <a href="ltr4.php"> <button type="button"  class="btn btn-danger btn-sm btn-glow" >Monthly Lab Stock Report</button></a>
