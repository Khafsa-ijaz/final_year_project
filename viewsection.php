...
if ($rowadv['pagename']=='View Projects')
{
   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Projects List</h4>
    ...
    <div class="row">
        <div class="col-12">
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">S.#</th>
                                    ...
                                    <th style="background-color:#304A7B;color: white  ">Area</th>
            ...
            $sql = "SELECT * FROM   pr order by id ";
    ...
    echo "
                                                 <a data-toggle='tooltip' title='Edit Project' href=editproject.php?id=".$row['id']."><button type='button' class='btn btn-icon btn-outline-warning btn-sm'><i class='fa fa-pencil'></i></button></a>
                                                 
                                        <button data-toggle='tooltip' title='Delete Project' type='button' value=Delete id=".$row['id']." class='btn btn-icon btn-outline-danger btn-sm cc'><i class='fa fa-trash'></i></button>";
