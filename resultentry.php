...
if ($rowadv['pagename']=='Result Enter')
{
...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Result Enter</h4>
  ...
  $sql = "SELECT DISTINCT termname FROM child_marks where session='$session'";
  ...
  ?>
          ...
          <?php
          include('connection.php');
  $sql = "SELECT DISTINCT class FROM child_marks where session='$session'";
  $result = $conn->query($sql);
  ...
  ?>
                ...
                <button name="submit"   onclick="return mess()" type="submit" value=""  class="btn btn-warning btn-min-width btn-glow mr-1 mb-1 " />Enter Result</button> 
                </form>
