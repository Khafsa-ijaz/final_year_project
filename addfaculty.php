...
if($file=='')
{
     $file = "Nill";
      ...
      $sql = "INSERT INTO faculty (fname,lname,email,qulification,designation,university,comments,file)
VALUES ('$fname', '$lname', '$email','$qulification','$designation','$university','$comments','$file')";
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Add New Faculty Form</h4>
            ...
            <div class="s text-center " role="" aria-label="Basic example">   
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="email" value="" autofocus="true" class="form-control" value="" name="email">
                                        </div>
 </div>
                           <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Qualification <span style="color:red">*</span> </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="qulification" value="" autofocus="true" class="form-control" value="" name="qulification">
                                        </div>
 </div>
                       ...
                       <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Comments<span style="color:red">*</span> </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="comments" value="" autofocus="true" class="form-control" value="" name="comments">
                                        </div>
 </div>
...
if (fname!='' )
{
 $.ajax({
                  type:'POST',
                    url: 'savefaculty.php',
                    dataType: 'json',
                    data: {fname:fname,lname:lname,email:email,qulification:qulification,designation:designation,university:university,comments:comments,file:file},
