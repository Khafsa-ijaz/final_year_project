...
function Header()
{
   ...
   $this->SetTextColor(0,0,0);
    ...
    $this->Cell(160,10,' EMPLOYEES LIST',0,0,'C');

 $this->Ln(7);
  $this->Cell(280,10,'DEPARTMENT: ' .$department,0,0,'C');
    $this->Ln(7);
    }
    else{
...
$sql = "SELECT * FROM employees where status='Active' and department='$department' order by ID DESC";
