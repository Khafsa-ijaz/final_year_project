    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">ClassWise Attendance Report</h4>
          ...
          <div class="card-body">
      <form class="form" method="POST" action="reportclassattendance">
              <div class="form-body">
            ...
            ?>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" name="submit" class="btn btn-warning btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-check-square-o"></i>  Class Attendance Report
                </button>
              </div>
            </form>
