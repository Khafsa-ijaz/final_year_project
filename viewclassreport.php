...
#myDiv {
  ...
  text-align: center;
   ...
   <meta name="description" content=" CS&IT DEPARTMENT Website Developed By Khafsa IJaz And Habeeba Mateen">
    ...
    <title>Classes Reports Area</title>
...
else
{
  ...
  <div class="row">
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to classes Reports Section</h4>
    ...
    <div class="col-md-12">
     ...
     <div class='col-md-4'>
                                            <li ><a style='' href='classfpdf.php'><i class='fa fa-file-text-o'></i> All Classes Report</a></li>
						</div>
  ...
  <?php
            ...
            ?>
                         ...
                         <form method="POST" action="InActiveClassesPDF">
