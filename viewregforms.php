...
if ($rowadv['pagename']=='Reports')
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls"><b><u>Add Tests DATE <?php echo $format?></b></u> <i><u></i></u></b></h4>
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                    ...
                    <div class="card-body card-dashboard">
                          <form  method="POST" action="dpr.php">
 ...
 <th style="background-color:#304A7B;color: white  ">VIEW/DELETE</th>
  ...
  $count=0;
         ...
         $sql = "SELECT * FROM patients where date='$date' order by date,id ";
                          ...
                          <div class='btn-group' role='group' aria-label='Basic example'>
                                        ...
                                        <a  data-toggle=tooltip' title='ADD TEST' href=addtest.php?id=".$row['id']."><button type='button' class='btn btn-icon btn-primary btn-sm'><i class='fa fa-medkit'></i></button></a>
                                          &nbsp
                                                  ...
                                                  <a  data-toggle=tooltip' title='ADD SERVICE' href=addtestse.php?id=".$row['id']."><button type='button' class='btn btn-icon btn-info btn-sm'><i class='fa fa-medkit'></i></button></a>
                                                      &nbsp
