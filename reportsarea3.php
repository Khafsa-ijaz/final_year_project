...
<hr>
         ...
         <a href="inca.php"> <button type="button"  class="btn btn-warning btn-sm btn-glow" > Ambulance KM Report</button></a>
   

            <a href="inca1.php"> <button type="button"  class="btn btn-info btn-sm btn-glow" >Montly Income Report</button></a>


                <a href="annualincomereport.php"> <button type="button"  class="btn btn-info btn-sm btn-glow" >Annual Income Report</button></a>



   <a href="inc44.php"> <button type="button"  class="btn btn-info btn-sm btn-glow" >Consult Wise Report(IMO+WMO)</button></a>
