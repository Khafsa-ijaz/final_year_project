...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Add New Student Form</h4>
 ...
 <a target="_blank" href=" "> </a>
   <a target="_blank" href="viewbsstudents.php"> <button type="button"  style="background-color: #1090CD !important"      class="btn btn-warning btn-sm " ><i class="fa fa-users"></i>&nbspStudents List</button></a>
           ...
           <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  maxlength="15" type="text" id="cnic" autofocus="true"  class="form-control" value="" name="username">
                       ...
                       <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="mobileno" autofocus="true" class="form-control" value="92" name="username">
    ...
    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="number" id="emno" autofocus="true" class="form-control" value="" name="username">
                                            <!-- <p style="color:#5B8343;"><b>Must Start with 92</b></p> -->
                                        </div>
 </div>
    <div class="col-md-6">
         ...
         <div class="col-md-6">
               ...
               <select style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="program" autofocus="true" class="form-control" value="" name="program">
                     ...
                     <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="gender" autofocus="true" class="form-control" value="" name="gender">
                 ...
                 <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="marital_status" autofocus="true" class="form-control" value="" name="marital_status">
                        ...
                        <option value="Single">Single</option>
                         ...
                         <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="vaccine_status"  autofocus="true" class="form-control" value="" name="vaccine_status">
  ...
  <h4 class="form-section"><i class="fa fa-graduation-cap"></i> Academics Matric</h4>
                <div class="row">
                    ...
                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;" type="text" id="Mboard" autofocus="true" class="form-control" value="" name="Mboard">
                     ...
                     <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input  style="box-shadow: 0 0 4px white;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="Tmarks" autofocus="true" class="form-control"  name="Tmarks">
         ...
         <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="number" id="Obmarks" autofocus="true" class="form-control" value="0" name="Obmarks">
                                        </div>
 </div>
         <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Percentage</label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="number" id="M_percentage" autofocus="true" class="form-control" value="0" name="M_percentage">
                                        </div>
 </div>
  ...
  <h4 class="form-section"><i class="fa fa-graduation-cap"></i> Academics Intermediate</h4>
                <div class="row">
                    ...
                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Board Name</label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;" type="text" id="Iboard" autofocus="true" class="form-control" value="" name="Iboard">
             ...
             <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;" type="text" id="Igroup" autofocus="true" class="form-control" value="" name="Igroup">
                     ...
                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Total Marks</label>
                                            <input  style="box-shadow: 0 0 4px white;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="It_marks" autofocus="true" class="form-control"  name="It_marks">
         ...
         <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Obtained  Marks</label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="number" id="Iob_marks" autofocus="true" class="form-control" value="0" name="Iob_marks">
                                        </div>
 </div>
         <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Percentage</label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="number" id="I_percentage" autofocus="true" class="form-control" value="0" name="I_percentage">
                                        </div>
 </div>
...
if (sname!='' && fname!='' && cnic!='')
{
 $.ajax({
                  type:'POST',
                    url: 'savebsstudents.php',
                    dataType: 'json',
                    data: {sname:sname,fname:fname,cnic:cnic,address:address,dob:dob,mobileno:mobileno,emno:emno,gender:gender,marital_status:marital_status,vaccine_status:vaccine_status,program:program,session:session,Iboard:Iboard,Igroup:Igroup,It_marks:It_marks,Iob_marks:Iob_marks,I_percentage:I_percentage,Mboard:Mboard,Tmarks:Tmarks,Obmarks:Obmarks,M_percentage:M_percentage,email:email},
