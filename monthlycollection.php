...
$a1=date("M",strtotime($month));
   ...
   $this->SetTextColor(48, 74, 123);
    $this->Cell(160,10,strtoupper($product). ' MONTHLY COLLECTION REPORT : '.$format,0,0,'C');
...
$ginti=0;
        ...
        $sql2 = "SELECT * FROM itable2 where month='$month' and product='$product' ";
...
$pdf->Cell(12,10,'S#',1,0,'C',1);
    $pdf->Cell(25,10,'FORM NO',1,0,'C',1);
        $pdf->Cell(25,10,'UNIT NO',1,0,'C',1);
    ...
    $pdf->Cell(30,10,'BOOKING PRICE',1,0,'C',1);
        ...
        $pdf->Cell(30,10,'MONTHLY RCVD',1,0,'C',1);
    
    
    
        $pdf->Cell(30,10,'TOTAL RCVD',1,0,'C',1);
    
$pdf->Cell(30,10,'DEFAULT AMOUNT',1,0,'C',1);

$pdf->Cell(30,10,'TOTAL BALANCE',1,0,'C',1);

$pdf->Cell(30,10,'PAYMENT DESCRIP',1,0,'C',1);
...
$pdf->Cell(25,6,$pno,1,0,'L');



$pdf->CellFitScale(40,6,$row2['name'],1,0,'L');
...
$pdf->Cell(30,6,number_format($tc),1,0,'C');
$pdf->Cell(30,6,number_format($row2['mbalamt']),1,0,'C');


$pdf->Cell(30,6,number_format($tb),1,0,'C');


$pdf->Cell(30,6,$row2['paymentdescription'],1,0,'L');

$balance=$row2['mbalamt']+$balance;
