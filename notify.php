...
<html lang="en">
  <head>
    ...
    <link href="https://bahria.edu.pk/buic/wp-content/themes/buhq_theme/css/all-stylesheets.css" rel="stylesheet">
  </head>
  <body>
    ...
    <div id="content-with-photo4-block" class="pt-2"> 
        <div class="container py-md-5">
                    ...
                    <div class="cwp4-text col-lg-8">
                        <h3 style="color:#1090CD; font-size:25px">Notifications</h3>
...
<!-- content-with-photo4 block -->
  ...
  <!-- News & Notification Starts -->
            <div class="col-lg-4 news">
                <h2 class="orange-bg"><i class="fa fa-bell-o" aria-hidden="true"></i> News &amp; Notifications</h2>
                <div class="box">
                    <!-- News Block Starts -->
                    
                        <div class="block">
                            <div class="date">24<br>Jul</div>
                            <div class="info">
                                <a href="https://bahria.edu.pk/buic/index.php/vacancy-available-camera-man-set-designer/"><div class="heading">Vacancy available (Camera Man &amp; Set Designer)</div></a>
                                <div class="description"></div>
                                <div class="readmore"><a href="https://bahria.edu.pk/buic/index.php/vacancy-available-camera-man-set-designer/"><i class="fa fa-book" aria-hidden="true"></i> Read More »</a></div>
                            </div>
                        </div>

                    
                        <div class="block">
                            <div class="date">23<br>Jul</div>
                            <div class="info">
                                <a href="https://bahria.edu.pk/buic/index.php/language-certification-courses/"><div class="heading">LANGUAGE CERTIFICATION COURSES</div></a>
                                <div class="description">Last updated on July 26th, 2024 This Summer Join the Language ...</div>
                                <div class="readmore"><a href="https://bahria.edu.pk/buic/index.php/language-certification-courses/"><i class="fa fa-book" aria-hidden="true"></i> Read More »</a></div>
                            </div>
                        </div>

                    
                        <div class="block">
                            <div class="date">11<br>Jul</div>
                            <div class="info">
                                <a href="https://bahria.edu.pk/buic/index.php/visiting-faculty-required-at-bu-e-8-campus/"><div class="heading">Visiting Faculty Required at BU E-8 Campus</div></a>
                                <div class="description">Last updated on July 15th, 2024</div>
                                <div class="readmore"><a href="https://bahria.edu.pk/buic/index.php/visiting-faculty-required-at-bu-e-8-campus/"><i class="fa fa-book" aria-hidden="true"></i> Read More »</a></div>
                            </div>
                        </div>

                    
                        <div class="block">
                            <div class="date">08<br>Jul</div>
                            <div class="info">
                                <a href="https://bahria.edu.pk/buic/index.php/merit-list-phd-candidates-fall-2024-phase-ii/"><div class="heading">Merit List – PhD Candidates Fall 2024 (Phase – II)</div></a>
                                <div class="description">Your Department will contact you for Research Proposal and further ...</div>
                                <div class="readmore"><a href="https://bahria.edu.pk/buic/index.php/merit-list-phd-candidates-fall-2024-phase-ii/"><i class="fa fa-book" aria-hidden="true"></i> Read More »</a></div>
                            </div>
                        </div>

                    
                        <div class="block">
                            <div class="date">07<br>Jul</div>
                            <div class="info">
                                <a href="https://bahria.edu.pk/buic/index.php/summer-school-on-international-maritime-law/"><div class="heading">Summer School on International Maritime Law</div></a>
                                <div class="description"></div>
                                <div class="readmore"><a href="https://bahria.edu.pk/buic/index.php/summer-school-on-international-maritime-law/"><i class="fa fa-book" aria-hidden="true"></i> Read More »</a></div>
                            </div>
                        </div>

                    
                        <div class="block">
                            <div class="date">27<br>Jun</div>
                            <div class="info">
                                <a href="https://bahria.edu.pk/buic/index.php/important-notice-deactivation-and-deletion-of-student-email-ids/"><div class="heading">Important Notice: Deactivation and Deletion of Student Email IDs</div></a>
                                <div class="description">This is to inform you that all email IDs of ...</div>
                                <div class="readmore"><a href="https://bahria.edu.pk/buic/index.php/important-notice-deactivation-and-deletion-of-student-email-ids/"><i class="fa fa-book" aria-hidden="true"></i> Read More »</a></div>
                            </div>
                        </div>

                                    
                    <!-- View All Starts -->
                    <div class="row blue-bg past-events">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><!-- <a href="">Past Events</a> --></div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 viewall"><a href="https://bahria.edu.pk/buic/index.php/latest-news/"><i class="fa fa-eye" aria-hidden="true"></i> View All</a></div>
                    </div>
                    <!-- View All Ends -->
                </div>
            </div>
