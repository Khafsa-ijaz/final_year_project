...
if($file=='')
{
  ...
  echo 'setTimeout(function () { swal("Error","Insert File!","danger");';
  echo '}, 500);</script>';
     
}
  else
  {
    $sql = "INSERT INTO video (fname,file)
VALUES ('$fname', '$file')";
if ($conn->query($sql) === TRUE) {
  echo '<script type="text/javascript">';
  echo 'setTimeout(function () { swal("SUCCESS","Videos Uploaded Successfully!","success");';
  echo '}, 1000);</script>';
  }   
...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Add New Video Form</h4>
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                       ...
                       <form class="form" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i> Add Video</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                       ...
                                       <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">upload Video <span style="color:red">*</span> </label>
 ...
 <div class="form-actions">
                                ...
                                <button  name="submit" style="background-color: #5B8343;color:white;border:1px solid #062F4F" type="submit" class="btn btn-outline-info ">
                                    <i class="fa fa-check"></i> Add Video
                                </button>
                            </div>
                            </form>
