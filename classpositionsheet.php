...
@keyframes spin {
  ...
  100% { transform: rotate(360deg); }
    ...
    <title>Class Position Sheet</title>
...
if ($rowadv['pagename']=='Class Position Sheet')
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Class Position Sheet</h4>
         ...
         <form target="_blank" class="form form-horizontal" method="POST" action="positionsheet">              <div class="form-body">
