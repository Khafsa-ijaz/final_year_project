...
echo "<input type='hidden' id='floorname' value='$floorname'/>";
  ...
  <div class="row">
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls"><b><u><?php echo $floorname?></b></u> <i><u></i></u></b> Price List</h4>
    ...
    <div class="row">
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                    ...
                    <div class="card-body card-dashboard">
                        ...
                        <form target="_blank" method="POST" action="pricelistpdf">
                       <input type="hidden" value="<?php echo $floorname?>" name="floorname">
      ...
      <hr style="  border-top: 2px dotted #304A7B;">
                        <table id="customer_data" sty class="table table-striped table-bordered file-export">
                            <thead>
                                <tr>
                               
                                      <th style="background-color:#304A7B;color: white ">CATEGORY</th>
                                       <th style="background-color:#304A7B;color: white ">FLOOR</th>
                                         <th style="background-color:#304A7B;color: white ">FLAT NO</th>
                                          <th style="background-color:#304A7B;color: white ">STATUS</th>
                                    <th style="background-color:#304A7B;color: white  ">SIZE SQ FT</th>
                                          <th style="background-color:#304A7B;color: white  ">PER SQFT PRICE</th>
                                           <th style="background-color:#304A7B;color: white  ">Total Price</th>
                                            <th style="background-color:#304A7B;color: white  ">DOWN PAYMENT (25%)</th>
                                         
                                             <th style="background-color:#304A7B;color: white  ">REMAINING AMOUNT</th>
                                                <th style="background-color:#304A7B;color: white  ">QUATERLY INSTALLMENTS</th>
...
messageTop: '<?php echo $floorname?>  Price List'
...
$(document).on('click','.cc',function(event){
 ...
 swal({
  title: "Are You Sure to Delete Floor Price?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
...
<script type="text/javascript" language="javascript" >
     ...
     function fill_datatable(floor = '', flatno = '')
  {
