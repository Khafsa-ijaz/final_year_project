    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Tests List</h4>
            ...
            <form class="form" method="POST" action="lab2.php">
              <div class="form-body">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="projectinput2">Select Category</label>
                         <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white" id="category" name="category" class="form-control">
                    <option value="All Tests"><span style="color:#304A7B">All Tests</span></option>
                        <?php
                        include('config.php');
                $department_query = "SELECT DISTINCT category FROM cat  order by ID DESC";
            ...
            ?>
              ...
              <div class="form-actions ">
                 <button tyle="background-color: #ffd338;color:black
                  ...
                  <i class="fa fa-check-square-o"></i> View Tests List
                </button>
