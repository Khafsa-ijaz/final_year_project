...
$sql = "SELECT status FROM menu where category='Courses Section' and user='$rowsession[username]'";
  ...
  while($row = $result->fetch_assoc()) {
    ...
    else
    {
        echo " 
            ...
            <li  class='nav-item'><a href='#'><i class='fa fa-book'></i><span class='menu-title' data-i18n='nav.page_layouts.main'>Courses Section</span></a>
