...
if ($rowadv['pagename']=='Bills History')
{
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                                   ...
                                   <h4 style="color:black" class="card-title" id="horz-layout-colored-controls"><b><u>Equipments List</b></u> <i><u></i></u></b></h4>
 ...
 <input type="hidden" value="<?php echo $bankname?>" name="bankname">
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">BARCODE</th>
                                    ...
                                    <th style="background-color:#304A7B;color: white  ">COMPANY</th>
  ...
  $count=0;
         ...
         $sql = "SELECT * FROM medicine where type='EQUIPMENT' order by name";
            ...
            $sql2 = "SELECT * FROM medicine2 where bcode='$row[bcode]'";
    ...
    $balamt=$balamt-$row2['amountout'];
           ...
           echo " <tr>
                  ...
                  <div class='btn-group' role='group' aria-label='Basic example'>
                    <a data-toggle='tooltip' title='Add Dispose' href=dispose.php?id=".$row['bcode']."><button type='button' class='btn btn-icon btn-primary btn-sm'><i class='   fa fa-recycle'></i></button></a>
                    
                    &nbsp
                     <a data-toggle='tooltip' title='Delete Dispose' href=itablef.php?id=".$row['bcode']."><button type='button' class='btn btn-icon btn-info btn-sm'><i class='   fa fa-undo'></i></button></a>
                     </div>
...
<div class='btn-group' role='group' aria-label='Basic example'>
            <a data-toggle=tooltip' title='EDIT' href=editeq.php?id=".$row['id']."><button type='button' class='btn btn-icon btn-outline-warning btn-sm'><i class='fa fa-pencil'></i></button></a>
...
$(document).on('click','.cc',function(event){
 ...
 .then((willDelete) => {
  if (willDelete) {
     $.ajax({
                url:"deleteform23.php?id="+del_id,
                cache:false,
