...
if ($rowadv['pagename']=='View Classes')
{
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Classes List</h4>
        ...
        <div class="col-12">
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                  ...
                  <div class="s text-center " role="" aria-label="Basic example">   <a target="_blank" href="classeslist"><button style="background-color: #304A7B;color: white !important" type="button" class="btn btn-outline-warning btn-sm btn-glow" >
                    Complete PDF
                  </button>
</a>
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">ID</th>
                                    ...
                                    <th style="background-color:#304A7B;color: white  ">Teacher</th>
                                          <th style="background-color:#304A7B;color: white  ">Fees</th>
                                           <th style="background-color:#304A7B;color: white  ">Group</th>
                                            <th style="background-color:#304A7B;color: white  ">Periods</th>
