...
if ($rowadv['pagename']=='School Report')
{
...
else
{
  ...
  <?php
      ...
      ?>
                      <h4 class="card-title">School Attendance List  <b><i style="color:red"> Date: </i><u><?php echo $date?></u><i style="color:red">To Date: </i></h4>
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                 ...
                 <div class="s text-center " role="" aria-label="Basic example"> 
                      <form method="POST" action="pdfschoolattendance">
  ...
  $count=0;
   ...
   $sqli = "SELECT class,regno,status FROM attendence where  date='$date' and session='$session' order by class ASC ";
...
dom: 'Blfrtip',
...

        {
           extend: 'csv',
           footer: false,
                  messageTop: '   School Attendance Chart of Date: <?php echo $format?>'
