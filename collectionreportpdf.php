...
$ginti=0;
        ...
        $sql2 = "SELECT * FROM itable where rcvddate between '$date' and '$date1' and rcvdamt!='0'";
...
$pdf->Cell(30,6,number_format($row2['monthlyinstallment']),1,0,'C');
  ...
  $sql22 = "SELECT * FROM itable where   accountnumber='$row2[accountnumber]'   order by id ASC LIMIT 1";
