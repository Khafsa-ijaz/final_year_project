...
else
{
  ...
  <div class="row">
    ...
    <div class="col-md-12">
       ...
       <div class='col-md-4'>
                                            <li ><a data-toggle='modal' data-target='#flipInY1'><i class='fa fa-file-text-o'></i> Daily Attendance Report</a></li>
						</div>
						                            ...
						                            <div class='col-md-4'>
                        <li ><a data-toggle='modal' data-target='#flipInY4'><i class='fa fa-file-text-o'></i>
                                Monthly Attendance Summary</a></li>
                                </div>
						                            ...
						                            <div class='col-md-4'>
                        <li ><a data-toggle='modal' data-target='#flipInY8e'><i class='fa fa-file-text-o'></i>
                                Employee Attendance Report</a></li>
                                </div>
                    ...
                    <div class="modal-content">
                      <div class="modal-header bg-info-outline" style="background-color:#5B8343">
                    ...
                    <form method="POST" action="dailyatten.php">
                            <div class="modal-body">
                          <label>Select Date: </label>
                          <div class="form-group">
                           <input s style="background-color: #1090CD;color:white;border:1px solid #5B8343" type="date" value="<?php echo date ("Y-m-d")?>" id="department" autofocus="true" class="form-control" value="" name="date">
                      ...
                      <button  style='background-color: #5B8343 !important;' type="submit" style="background-color: #5B8343;color: white !important" type="button" class="btn btn-danger btn-sm " >
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i><span class="blink-soft"> Daily Attendance Report</span>
                  </button>
              </form>
                          </div>
                        </form>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                    <form method="POST" action="DailySummary">
                            <div class="modal-body">
                          <label>Select Date: </label>
                          <div class="form-group">
                           <input s style="background-color: #5B*#$#;color:white;border:1px solid #B82601" type="date" value="<?php echo date ("Y-m-d")?>" id="department" autofocus="true" class="form-control" value="" name="date">
                    ...
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i><span class="blink-soft"> Daily Attendance Summary Report</span>
                  </button>
              </form>
                          </div>
                        </form>
                                     ...
                                     <div class="modal animated swing text-left" id="flipInY8" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                    <form method="POST" action="monthlyleaves.php">
                            <div class="modal-body">
                    ...
                    <form method="POST" action="SummaryMonthly">
                          ...
                          <label>Select Month: </label>
                          <div class="form-group">
                           <input s style="background-color: #1090CD;color:white;border:1px solid #B82601" type="month" value="<?php echo date ("Y-m")?>" id="department" autofocus="true" class="form-control" value="" name="month">
                         ...
                         <form method="POST" action="InActiveEmployeesPDF">
                      <button  style='background-color: #5B8343!important;' type="submit" style="background-color: #3EBBE5;color: white !important" type="button" class="btn btn-danger btn-sm " >
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i><span class="blink-soft"> Monthly Attendance Summary</span>
                     ...
                     <div class="modal animated swing text-left" id="flipInY8e" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header bg-info-outline" style="background-color:#5B8343">
                      <h4 style="color:white" class="modal-title" id="myModalLabel62">Select Dates</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
                        <span aria-hidden="true">&times;</span>
                      </button>
                      </div>
                      <div class="modal-body">
                    <form method="POST" action="singleatten.php">
                            <div class="modal-body">
                          ...
                          <div class="form-group">
                           <select s style="background-color: #1090CD;color:white;border:1px solid #B82601" type="text" id="department" autofocus="true" class="form-control" value="" name="id">

  <?php
                        include('config.php');
                $department_query = "SELECT id,name FROM employees ";
            ...
            ?>
                          ...
                          <div class="form-group">
                           <input s style="background-color: #1090CD;color:white;border:1px solid #B82601" type="date" value="<?php echo date ("Y-m-d")?>" id="department" autofocus="true" class="form-control" value="" name="date">
              ...
              <label>End Date: </label>
                          <div class="form-group">
                           <input s style="background-color: #1090CD;color:white;border:1px solid #B82601" type="date" value="<?php echo date ("Y-m-d")?>" id="department" autofocus="true" class="form-control" value="" name="date1">
                         ...
                         <form method="POST" action="InActiveEmployeesPDF">
                      <button  style='background-color: #5B8343 !important;' type="submit" style="background-color: #5B8343;color: white !important" type="button" class="btn btn-danger btn-sm " >
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i><span class="blink-soft"> Single Employee Attendance</span>
                  </button>
              </form>
                          </div>
                        </form>
...
<option value="SL">Short Leave</option>
                    ...
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i><span class="blink-soft"> Daily Absent / Leave Report</span>
                                   ...
                                   <div class="modal animated swing text-left" id="flipInY6" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                      <h4 style="color:white" class="modal-title" id="myModalLabel62">Select Your Date</h4>
                      ...
                      <div class="modal-body">
                    <form method="POST" action="workingreportpdf">
                            <div class="modal-body">
                          <label>Select Date: </label>
                          <div class="form-group">
                           <input s style="background-color: #4C6586;color:white;border:1px solid #B82601" type="date" value="<?php echo date ("Y-m-d")?>" id="department" autofocus="true" class="form-control" value="" name="date">
                         ...
                         <form method="POST" action="InActiveEmployeesPDF">
                      <button  style='background-color: #3EBBE5 !important;' type="submit" style="background-color: #3EBBE5;color: white !important" type="button" class="btn btn-danger btn-sm " >
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i><span class="blink-soft"> Working Hours Report</span>
                  </button>
              </form>
                          </div>
                        </form>
                                   ...
                                   <div class="modal animated swing text-left" id="flipInY7" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                      <h4 style="color:white" class="modal-title" id="myModalLabel62">Select Your Date</h4>
                      ...
                      <div class="modal-body">
                    <form method="POST" action="workingreportpdf1">
                            <div class="modal-body">
                          <label>Starting Month: </label>
                          <div class="form-group">
                           <input s style="background-color: #4C6586;color:white;border:1px solid #B82601" type="month" value="<?php echo date ("Y-m")?>" id="month" autofocus="true" class="form-control" value="" name="month">
                         ...
                         <form method="POST" action="InActiveEmployeesPDF">
                      <button  style='background-color: #3EBBE5 !important;' type="submit" style="background-color: #3EBBE5;color: white !important" type="button" class="btn btn-danger btn-sm " >
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i><span class="blink-soft"> Monthwise Working Hours</span>
                  </button>
              </form>
                          </div>
                        </form>
