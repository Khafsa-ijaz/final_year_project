...
if(isset($_GET['id'])){
    ...
    $userid = $_GET['id'];
    $get_user = mysqli_query($conn,"SELECT * FROM medicine3 WHERE bcode='$userid'");
...
if(isset($_POST['submit']))
 ...
 $sql123 = "SELECT * FROM medicine3 where bcode='$bcode'";
...
$sql222 = "INSERT INTO medicine4 (name,qty,unit,cname,type,location,vendor,bcode,date,amountin,amountout,mr,info,month) 
  VALUES('$name','0','$unit','$cname','$type','$location','$vendor','$bcode','$d','0','$dis','0','$info','$month')";
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Welcome to DISPOSE Medicine  Form</h4>
            ...
            <div class="s text-center " role="" aria-label="Basic example">   <button type="button" class="btn btn-info btn-sm btn-glow" data-toggle="modal" data-target="#flipInY">
                    ...
                    <div class="modal-content">
                      ...
                      <h5>DISPOSE Your Medicine</h5>
                      <p>DISPOSE Medicine</p>
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input readonly="" style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value="<?php echo $roww['bcode']?>" placeholder="" id="bcode" name="bcode">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input readonly="" style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control"  value="<?php echo $roww['name']?>" autofocus="true" placeholder="" id="name" name="name">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label style="color:black" class="col-md-3 label-control" for="userinput1">DISPOSING QTY</label>
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value="0" autofocus="true"  placeholder="" id="qty" name="qty">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div style="display: none" class="loader"></div>
                       ...
                       <button name="submit"  style="background-color: #ffd338;color:black
                       ; !important" type="submit" class="btn btn-warning">
                                  <i class="fa fa-check-square-o"></i> DISPOSE 
                              </button>
...
if (bcode=='')
{
 ...
 $.ajax({
                  type:'POST',
                    url: 'savefloor22.php',
                    dataType: 'json',
                   data: {name:name,qty:qty,unit:unit,cname:cname,type:type,location:location,vendor:vendor,bcode:bcode,date:date},
...
if (data[0]['success']=='success')
 ...
 if (data[0]['duplicate']=='duplicate')
    ...
    text: 'Duplicate Equipment Found.....',
    type: 'danger',
    timer: 2500,
    showConfirmButton: false
  }).then(function() {
