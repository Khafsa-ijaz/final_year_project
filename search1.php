  ...
  <a  href="viewheads"> </a>
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                        ...
                        <div class="form-body">
                          <h4 sty class="form-section" style="color: black" ><i class="fa fa-user"></i> Add New File</h4>
                          <div class="row">
            <!--       <div class="col-md-6">
                    <div class="form-group">
                      <label for="projectinput2">Add File </label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="projectinput1">Add File</label>
                      <input style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white" type="text" required="" autofocus="true" id="file" class="form-control" placeholder="" name="file">
