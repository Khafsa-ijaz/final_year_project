    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                    <h4 style="color:black" class="card-title" id="horz-layout-colored-controls"><b><u><?php echo $category?></b></u> <i><u></i></u></b>  List</h4>
                            ...
                            <thead>
                                <tr>
                                      ...
                                      <th style="background-color:#304A7B;color: white ">CATEGORY</th>
                                              ...
                                              <th style="background-color:#304A7B;color: white  ">SUBCATEGORY</th>
                                      
                                      
                                    <th style="background-color:#304A7B;color: white  ">NAME</th>
                                    <th style="background-color:#304A7B;color: white  ">UNIT</th>
                                          <th style="background-color:#304A7B;color: white  ">REFERCNE RANGE</th>
