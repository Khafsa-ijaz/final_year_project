    ...
    <div style='display:none' class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">View Cost</h4>
 ...
 <select s style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white" type="text" id="pr" autofocus="true" class="form-control" value="" name="name">
    ...
    <div class="col-md-6">
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="crp.php">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-tasks"></i> Tasks Requirement</h4>
                <div class="row">
 ...
 <select s style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white" type="text" id="pr" autofocus="true" class="form-control" value="" name="name">
            ...
            ?>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"   class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-get-pocket"></i> View Cost
                </button>
              </div></form>
