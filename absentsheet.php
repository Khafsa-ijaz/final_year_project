...
@keyframes spin {
  ...
  100% { transform: rotate(360deg); }
    ...
    <title>Subject Absent Sheet</title>
...
if ($rowadv['pagename']=='Subject Absent Sheet')
{
...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Subject Absent Sheet</h4>
         ...
         <form  target="_blank" class="form form-horizontal" method="POST" action="pdfabsentsheet">              <div class="form-body">
  ...
  ?>
          ...
          <?php
          include('connection.php');
  $sql = "SELECT DISTINCT class  FROM result_entry where csession='$session'";
  $result = $conn->query($sql);
  ...
  ?>
               ...
               <div class="col-md-4">
                 ...
                 <div class="form-group">
                  ...
                  <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;"  required="" id="subjectname" name="subjectname" class="form-control">
                    <?php
  include('connection.php');
  $sql = "SELECT DISTINCT subject  FROM result_entry where session='$session'";
  $result = $conn->query($sql);
  ...
  ?>
                ...
                <button name="submit"    type="submit" value=""  class="btn btn-warning btn-min-width btn-glow mr-1 mb-1" />Subject Absent Sheet</button> 
                </form>
