   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls"> <b><i><u> <?php echo $sname?> Uploaded Files List </b> </u> </i></h4>
    ...
    <div class="row">
      ...
      <hr style="  border-top: 2px dotted #5B8343;">
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#1090CD;color: white ">S.#</th>
                                      <th style="background-color:#1090CD;color: white "> FILE NAME</th>
                                    <th style="background-color:#1090CD;color: white  ">VIEW</th>
            ...
            $sql = "SELECT * FROM files where reg_no='$id' order by id DESC";
...
$image=$row['image'];
              ...
              <td>
                 ".$row['file_name']."</td>
      <td> <a target='_blank' href='uploads/$row[file]'> <span class='badge bg-success'>View File</span></a></td>
...
<td>
                             ...
                             <button data-toggle='tooltip' title='Delete Files' type='button' value=Delete id=".$row['id']." class='btn btn-icon btn-danger btn-sm cc'><i class='fa fa-trash'></i></button>
