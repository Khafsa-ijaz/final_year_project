    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Employees Search Section</h4>
        ...
        <div class="box box-primary border0 mb0 margesection">
            ...
            <div class="">
                ...
                <ul class="reportlists">
                    <div class="row">
                        <div class="col-md-3">
                                            <li ><a data-toggle="modal" data-target="#flipInY" style='' href="employeeslist"><i class="fa fa-search"></i> Search by Name</a></li>
						</div>
						                        <div class="col-md-3">
                          <li ><a data-toggle="modal" data-target="#flipInY1" ><i class="fa fa-search"></i>  Search by ID</a></li>
						  </div>
						  
                                                <div class="col-md-3">
                        <li ><a data-toggle="modal" data-target="#flipInY2" ><i class="fa fa-search"></i>
                                Search by CNIC</a></li>
                                </div>
                        
                             <div class="col-md-3">
                        <li ><a data-toggle="modal" data-target="#flipInY3"><i class="fa fa-search"></i>
                                Search by Mobile No</a></li>
                                </div>
                                  ...
                                  <div class="modal animated flipInX text-left" id="flipInY" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                      <h4 style="color:white" class="modal-title" id="myModalLabel62">Search by Name</h4>
                    ...
                    <form method="POST" action="ByName">
                          ...
                          <div class="form-group">
                           <input s style="background-color: #4C6586;color:white;border:1px solid #B82601" type="text" id="department" autofocus="true" class="form-control" value="" name="name">
                    ...
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i><span class="blink-soft"> View Employees</span>
                  </button>
              </form>
                          </div>
                        </form>
                                  ...
                                  <div class="modal animated flipInX text-left" id="flipInY1" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                      <h4 style="color:white" class="modal-title" id="myModalLabel62">Search by ID</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                      </div>
                      <div class="modal-body">
                    <form method="POST" action="ById">
                            <div class="modal-body">
                          <label>Employee ID: </label>
                          <div class="form-group">
                           <input s style="background-color: #4C6586;color:white;border:1px solid #B82601" type="text" id="department" autofocus="true" class="form-control" value="" name="id">
                    ...
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i><span class="blink-soft"> View Employees</span>
                                ...
                                <div class="modal animated flipInX text-left" id="flipInY2" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                      <h4 style="color:white" class="modal-title" id="myModalLabel62">Search by CNIC</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                      </div>
                      <div class="modal-body">
                    <form method="POST" action="ByCnic">
                            <div class="modal-body">
                          <label>Employee CNIC: </label>
                          <div class="form-group">
                           <input s style="background-color: #4C6586;color:white;border:1px solid #B82601" type="text" id="department" autofocus="true" class="form-control" value="" name="nic">
                    ...
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i><span class="blink-soft"> View Employees</span>
                                ...
                                <div class="modal animated flipInX text-left" id="flipInY3" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                      <h4 style="color:white" class="modal-title" id="myModalLabel62">Search by Mobile No</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                      </div>
                      <div class="modal-body">
                    <form method="POST" action="bymob.php">
                            <div class="modal-body">
                          <label>Employee Mobile No: </label>
                          <div class="form-group">
                           <input s style="background-color: #4C6586;color:white;border:1px solid #B82601" type="text" value="92" id="department" autofocus="true" class="form-control" value="" name="mob">
