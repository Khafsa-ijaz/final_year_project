...
if ($rowadv['pagename']=='view Notifications')
{
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Notification  List</h4>
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#1090CD;color: white ">S.#</th>
                                      <th style="background-color:#1090CD;color: white ">Notication Title</th>
                                    <th style="background-color:#1090CD;color: white  ">Writer Name</th>
                                              <th style="background-color:#1090CD;color: white  ">Notification</th>
...
$(".cc").click(function(e) {
 ...
 .then((willDelete) => {
  if (willDelete) {
     $.ajax({
                url:"deletnotification.php?id="+del_id,
                cache:false,
