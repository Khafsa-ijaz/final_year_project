...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $userid = $_GET['id'];
    $get_user = mysqli_query($conn,"SELECT * FROM medicine3 WHERE id='$userid'");
...
$sql = "SELECT * FROM unitrate where bcode='$bcode' and month='$month'";
...
$sql22 = "SELECT DISTINCT month FROM unitrate where bcode='$bcode'";
...
if ($new>=$month)
{
  $sql44 ="update unitrate set unit='$unit' where bcode='$bcode' and month='$new'";
...
$sql222 = "INSERT INTO unitrate (bcode, name, unit,date,month)
VALUES ('$bcode', '$name', '$unit','$date','$month')";
...
if ($conn->query($sql222) === TRUE) {
 ...
 $sql ="update medicine3 set qty='$qty',unit='$unit',cname='$cname',vendor='$vendor',location='$location',alt='$alt',cat='$cat',pack='$pack' where id='$userid'";
    if ($conn->query($sql) === TRUE) {




 $sql2 ="update medicine4 set qty='$qty',unit='$unit',amountin='$qty',cname='$cname',vendor='$vendor',location='$location',month='$month' where info='***OPENING BALANCE***' and bcode='$bcode'";
...
?>
  ...
  <li  class=" nav-item"><a href="#"><i class="icon-layers"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Medicine Section</span></a>
            <ul class="menu-content">


   <?php
                $sqladv = "SELECT pagename,link FROM menu where category='Medicine Section' and status='1' and user='$rowsession[username]'";
...
if ($rowadv['pagename']=='Add Medicine')
{
...
if ($rowadv['pagename']=='Patients List')
{
...
if ($rowadv['pagename']=='View/Delete/Dispose')
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Welcome to Add New Medicine  Form</h4>
            ...
            <div class="s text-center " role="" aria-label="Basic example">   <button type="button" class="btn btn-info btn-sm btn-glow" data-toggle="modal" data-target="#flipInY">
                    ...
                    <div class="modal-content">
                      ...
                      <h5>Add Your Medicine</h5>
                      <p>Add Your Test Medicine</p>
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                        ...
                        <div class="form-body">
                          <h4 sty class="form-section" style="color: black" ><i class="fa fa-user"></i> Medicine Info</h4>
                          <div class="row">
                              <div class="col-md-6">
                                <div class="form-group row">
                                    <label style="color:black" class="col-md-3 label-control" for="userinput1">Item Barcode</label>
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value="<?php echo $roww['bcode']?>" readonly="" autofocus="true" placeholder="" id="bcode" name="bcode">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value="<?php echo $roww['name']?>" readonly="" autofocus="true" placeholder="" id="name" name="name">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label style="color:black" class="col-md-3 label-control" for="userinput1">QTY (SATRTING)</label>
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value="<?php echo $roww['qty']?>"  placeholder="" id="qty" name="qty">
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                        <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value="<?php echo $roww['unit']?>"  placeholder="" id="unit" name="unit">
                                    </div>
                                </div>
                            </div>
  <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value="<?php echo $roww['cname']?>"   placeholder="" id="cname" name="cname">
                                    </div>
                                </div>
                            </div>
...
<div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                       <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" id="type" name="type" class="form-control">
                    




    <option value="<?php echo $roww['type']?>"><?php echo $roww['type']?></option>
                        ...
                        <option value="Tablet">Tablet</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                       <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" id="cat" name="cat" class="form-control">
    ...
    <option value="<?php echo $roww['cat']?>"><?php echo $roww['cat']?></option>
...
if ($result22->num_rows > 0) {
  ...
  while($row22 = $result22->fetch_assoc()) {
          echo "<option value='".$row22['iname']."''>".$row22['iname']."</option>";
            ...
            ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label style="color:black" class="col-md-3 label-control" for="userinput1">Packing</label>
                                  <div class="col-md-9">
                                        <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value="<?php echo $roww['pack']?>"  placeholder="" id="pack" name="pack">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label style="color:black" class="col-md-3 label-control" for="userinput1">Alternate</label>
                                  <div class="col-md-9">
                                        <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value="<?php echo $roww['alt']?>" value=""  placeholder="" id="alt" name="alt">
                                    </div>
                                </div>
                            </div>
  ...
  <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="date"  class="form-control" value="<?php echo date("Y-m-d")?>" placeholder="" id="date" name="date">

                                      <p style="color: red"><b>Verify Month for unit rate</b></p>
                                    </div>
                                </div>
                            </div>
  ...
  <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <textarea style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;height:100px" type="text"  class="form-control" value=""  placeholder="" id="location" name="location"><?php echo $roww['location']?></textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div style="display: none" class="loader"></div>
                       ...
                       <button name="submit" type="submit" style="background-color: #ffd338;color:black
...
if (name=='')
{
    ...
    text: 'Please Write Medicine Name.....',
    type: 'danger',
    timer: 2500,
...
if (bcode=='')
{
 ...
 $.ajax({
                  type:'POST',
                    url: 'savefloor22m.php',
                    dataType: 'json',
                   data: {name:name,qty:qty,unit:unit,cname:cname,type:type,location:location,vendor:vendor,bcode:bcode,date:date,alt:alt,cat:cat,pack:pack},
