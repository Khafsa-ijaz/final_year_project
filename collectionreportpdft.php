...
$this->Cell(25,10,'ADVANCE',1,0,'C',1);
...
$ginti=0;
        ...
        $sql2 = "SELECT * FROM itable2 where rcvddate between '$date' and '$date1' and rcvdamt!='0'";
...
$pdf->Cell(25,10,'ADVANCE',1,0,'C',1);
...
$pdf->Cell(30,6,number_format($row2['monthlyinstallment']),1,0,'C');
  ...
  $sql22 = "SELECT * FROM itable2 where   accountnumber='$row2[accountnumber]'   order by id ASC LIMIT 1";
...
if ($result22->num_rows > 0) {
           ...
           while($row22 = mysqli_fetch_assoc($result22))  {
            ...
            $pdf->Cell(25,6,number_format($row2['rcvdamt']),1,0,'C');
     $pdf->Cell(25,6,'0',1,0,'C');
   
     
     $sum2=$row2['rcvdamt']+$sum2;
...
$pa=$row2['totalamount']-$pp;
$pa2=$pa/$tp;



                     $sum3=$row2['rcvdamt']+$sum3;
...
$pdf->Cell(20,6,'SUBTOTAL:',0,0,'R');
 //$pdf->Cell(40);
$pdf->Cell(25,6,number_format($sum2),1,0,'C');
$pdf->Cell(25,6,number_format($sum3),1,0,'C');

$t=$sum2+$sum3;
 $pdf->Ln(7);
 $pdf->Cell(207);
 $pdf->SetFont('Arial','B',8);
$pdf->Cell(20,6,'TOTAL COLLECTION:',0,0,'R');
 //$pdf->Cell(40);
...
$pdf->Cell(50,6,number_format($t),1,0,'C');
