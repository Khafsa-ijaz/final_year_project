    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">DateWise Staff Report</h4>
          ...
          <div class="card-body">
      <form class="form" method="POST" action="staffchart">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-clock-o"></i> Report Requirments</h4>
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label style="color: black" for="projectinput1">Select Staff Member</label>
                 <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" id="cteacher"  required="" name="id"  class="form-control">
                    
                           <?php
                        include('config.php');
                $department_query = "SELECT * FROM employees where status='Active' order by ID ASC";
            ...
            ?>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" name="submit" class="btn btn-warning btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-check-square-o"></i>  Staff Attendence DateWise
                </button>
              </div>
            </form>
