...
$status=$_POST['status'];
   ...
   $this->SetTextColor(0,0,0);
    ...
    $this->Cell(180,10,$cnamee. '  Students List '.$status,0,0,'C');
...
$sql = "SELECT * FROM students where curr_class='$curr_class' and status='$status'";
...
$pdf->Cell(15,6,$row['regno'],1,0,'L');
$pdf->Cell(50,6,$row['sname'],1,0,'L');
$pdf->Cell(50,6,$row['fname'],1,0,'L');
$pdf->Cell(25,6,$row['mob'],1,0,'L');
$pdf->SetFont('Arial','I',5.5);
$pdf->Cell(65,6,$row['address'],1,0,'L');
$pdf->Cell(33,6,$cname,1,0,'L');
$pdf->Cell(20,6,number_format($row['newfee']),1,0,'C');
...
$pdf->Cell(15,6,$row['regno'],1,0,'L',1);
$pdf->Cell(50,6,$row['sname'],1,0,'L',1);
$pdf->Cell(50,6,$row['fname'],1,0,'L',1);
$pdf->Cell(25,6,$row['mob'],1,0,'L',1);
$pdf->SetFont('Arial','I',5.5);
$pdf->Cell(65,6,$row['address'],1,0,'L',1);
$pdf->Cell(33,6,$cname,1,0,'L',1);
$pdf->Cell(20,6,number_format($row['newfee']),1,0,'C',1);
