...
@keyframes spin {
  ...
  100% { transform: rotate(360deg); }
    ...
    <title>Subject Fail Sheet</title>
...
if ($rowadv['pagename']=='Subject Fail Sheet')
{
...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Subject Fail Sheet</h4>
         ...
         <form  target="_blank" class="form form-horizontal" method="POST" action="pdffailsheet">              <div class="form-body">
  ...
  ?>
                ...
                <button name="submit"    type="submit" value=""  class="btn btn-warning btn-min-width btn-glow mr-1 mb-1" />Subject Fail Sheet</button> 
                </form>
