    ...
    <div class="container" style="color:white;">
      ...
      <div class="top-hd" style="background-color:#5B8343; color:white;" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto" style="color:white;">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://localhost/integrate/university%20societies/university%20societies/project" style="color: white;"><b>Socities</b></a>
          </li>
...
<section class="w3l-about-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>Graphs</h2>
      <p><a href="index12.php">Home</a> &nbsp; / &nbsp;<a href="programs.php">Survay</a> </p>
    </div>
  </div>
</section>
<!-- content-with-photo4 block -->
<section class="w3l-content-with-photo-4" style="text-align:center;">
  <!-- <h1 class="mt-5 pt-5" style="color:#1090CD"></h1> -->
    <div id="content-with-photo4-block" class="pt-5" > 

        <div class="container py-md-5">
            <div class="cwp4-two row">
                 <div class="cwp4-text col-lg-8" style="margin-left:-150px; margin-top: -160px;">
                        <!-- <h1 style="color:#1090CD; font-size:35px;font-weight: bold;">Graphical Representation</h1> -->
                   
                  
                </div>
                <div class="cwp4-text col-lg-9" >
                  <?php  
                     $chart_qry = $conn->query("SELECT * FROM `graphic_represintation`");
$chart_data = mysqli_fetch_array($chart_qry);


$working_qry = $conn->query("SELECT * FROM accounts WHERE currently_doing_what = 'working'");
$working = mysqli_num_rows($working_qry);


$studying_qry  = $conn->query("SELECT * FROM accounts WHERE currently_doing_what = 'studying'");
$studying = mysqli_num_rows($studying_qry);


$unemployed_qry  = $conn->query("SELECT * FROM accounts WHERE currently_doing_what = 'unemployed'");
$unemployed = mysqli_num_rows($unemployed_qry);
...
<script type="text/javascript">
  ...
  function drawChart() {
    var data = google.visualization.arrayToDataTable([
      ['Task', 'Hours per Day'],
      ['Work', <?php echo $working ?>],
      ['Unemployed', <?php echo $unemployed ?>],
      ['Studying', <?php echo $studying ?>],
    ]);
...
<div class="container-fluid parent" style="margin-top: -95px;">
  <div class="row" >

    <h1 class="mt-5 pt-5" style="color:#1090CD;font-weight: bold;">Graphical Representation</h1>
    <div class="col-6">
      ...
      <div class="row gy-4">
        <div class="col-12 col-md-6">
          <div class="stat-box">
            ...
            <div class="stat-description">of our graduates got jobs related to the degree they received at our university.</div>
          </div>
        </div>
        <div class="col-12 col-md-6">
          <div class="stat-box">
            <div class="stat-number">780</div>
            <div class="stat-description">Proudly boasting a network of over 780 successful alumni.</div>
          </div>
        </div>
        <div class="col-12 col-md-6">
          <div class="stat-box">
            <div class="stat-number">10</div>
            <div class="stat-description">Strategic MOUs were signed by Namal University in 2023, solidifying its commitment to alumni success and strengthening partnerships for enhanced opportunities in employment and career progression.</div>
          </div>
        </div>
        <div class="col-12 col-md-6">
          <div class="stat-box">
            <div class="stat-number">7%</div>
            <div class="stat-description">of our alumni have successfully launched their own ventures.</div>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="d-grid grid-col-4 footer-top-29">
              <div class="footer-list-29 footer-1">
                  ...
                  <ul>
                      ...
                      <li><a href="tel:+7-800-999-800"><span class="fa fa-phone"></span> +92 346 5167137</a></li>
                      <li><a href="mailto:corporate-mail@support.com" class="mail"><span class="fa fa-envelope-open-o"></span> goharrehman@wuajk.edu.pk</a></li>
                  </ul>
