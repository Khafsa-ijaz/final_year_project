		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls"><b><u> View  Insatallment Plan Against<?php echo $cnic?></u></b> </h4>
        ...
        <div class="col-12">
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                    ...
                    <h4 style="color:blue; font-size:25px;" class="card-title" id="horz-layout-colored-controls">Search Result Against CNIC <b><u><?php echo $cnic?> </b></u>
                    <br>
                    
                    
                    
                    <?php
                    $sql11 = "SELECT name,contact FROM multistory where cnic='$cnic' order by id ASC Limit 1";
...
?>
                    ...
                    Name: <b><u><?php echo $name?></u></b>&nbsp &nbsp &nbspContact: <b><u><?php echo $contact?></u></b> 
                    
                    </h4>
      </div>
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">Form.#</th>
                                   
                                      <th style="background-color:#304A7B;color: white ">Property Number</th>
                                      <th style="background-color:#304A7B;color: white ">Property Type</th>
                                    <th style="background-color:#304A7B;color: white  ">Floor</th>
                                    <th style="background-color:#304A7B;color: white  ">Category</th>
                                    <th style="background-color:#304A7B;color: white  ">Total Price</th>
                                    
                                                    <th style="background-color:#304A7B;color: white  ">Plan</th>
            ...
            $sql = "SELECT * FROM  multistory where cnic='$cnic'";
            ...
            // output data of each row
             while($row = mysqli_fetch_assoc($result))  {
              ...
              <td >".$row['id']."</td>
                 ...
                 echo "
                           <td>
                           	<a target='_blank' href=previewinstallment223.php?accountnumber=".$row["id"].">
                           	 
                      
                      
                           	
                                    <button type='button' class='btn btn-icon btn-outline-warning btn-sm'><i class='fa fa-building'></i></button>
                                    </a>
                                    </td>
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Complete Form No?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
