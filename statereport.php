...
function Header()
{
   ...
   $this->SetTextColor(0,0,0);
    ...
    $this->Cell(130,10,'DAILY ATTENDANCE REPORT',0,0,'C');



    $this->Ln(7);
  $this->Cell(190,10,'DATE: ' .$format1 .' STATE: '.$state,0,0,'C');
...
$pdf->Cell(20,7,'STATUS',1,0,'L',1);
    ...
    // Title
           ...
           $sum1=0;
                 $sum2=0;
                       $sql = "SELECT * from tattendence where date='$date' and status='$state' ";
                            ...
                            while($row =  mysqli_fetch_array($resultt)){
                                ...
                                $query2="SELECT * FROM employees where id='$row[emp_id]' and status='Active'";
...
$pdf->CellFitScale(60,6,$row22['name'],1,0,'L');
...
$pdf->CellFitScale(60,6,$row['remarks'],1,0,'L');
$pdf->Ln(7);
