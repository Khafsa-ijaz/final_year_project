...
if($file=='')
{
     $file = "Nill";
      ...
      $sql = "INSERT INTO responsibility(responsibility,tor,fid)
VALUES ('$responsibility','$tor','$id')";
if ($conn->query($sql) === TRUE) {
  echo '<script type="text/javascript">';
  echo 'setTimeout(function () { swal("SUCCESS","Conference Uploaded Successfully!","success");';
  echo '}, 1000);</script>';
...
if ($rowadv['pagename']=='Add Responsibility')
{
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                       ...
                       <form class="form" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i>Faculty Responsibilty</h4>
                                <div class="row">
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
   ...
   echo "<option value='".$row['id']."''>".$row['fname']."</option>";
                              ...
                              <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Enter Responsibility<span style="color:red">*</span> </label>
                                            <input  style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="responsibility" value="" autofocus="true" class="form-control" value="" name="responsibility">
                                        </div>
 </div>
                          <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Tasks<span style="color:red">*</span> </label>
                                            <input  style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="tor" value="" autofocus="true" class="form-control" value="" name="tor">
                                        </div>
 </div>       
                    ...
                    <div  style="display: none" class="loader"></div>
                            ...
                            <div class="form-actions">
                                ...
                                <button  name="submit" style="background-color: #5B8343;color:white;border:1px solid #062F4F" type="submit" class="btn btn-outline-info ">
                                    <i class="fa fa-check"></i> Add Responsibility
                                </button>
                            </div>
                            </form>
