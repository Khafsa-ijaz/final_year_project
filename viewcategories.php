...
if ($rowadv['pagename']=='View Categories')
{
   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Categories List</h4>
    ...
    <div class="row">
        <div class="col-12">
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">S.#</th>
                                      ...
                                      <th style="background-color:#304A7B;color: white ">Project Cat</th>
                                
                                  <th style="background-color:#304A7B;color: white ">Plot Cat</th>
            ...
            $sql = "SELECT * FROM   category order by project ";
