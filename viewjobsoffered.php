        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Jobs Applicants</h4>
...
// Prepare and execute the SQL query to fetch job details
$sql = $conn->query("SELECT * FROM jobs WHERE id = '$job_id'");
...
if (mysqli_num_rows($sql)>0){
    ...
    <div class="container mt-5">
        <!-- <h2 style="color:#1090CD; font-weight: bold;font-size: 30px;">View Job</h2> -->
        <div class="card bg-secondary-outline" style=" color: #1090CD;">
            <div class="card-header" style="color:#1090CD; font-weight: bold;font-size: 30px;">
                Job Details
            </div>
            <div class="card-body" style="color:black; font-weight: bold;font-size: 15px;">
                <h5 class="card-title">Job Title: <?php echo htmlspecialchars($job['title']); ?></h5>
                <p class="card-text"><strong style="color:#5B8343">Name:</strong> <?php echo htmlspecialchars($job['name']); ?></p>
                <p class="card-text"><strong style="color:#5B8343">Job Type:</strong> <?php echo htmlspecialchars($job['job_type']); ?></p>
                <p class="card-text"><strong style="color:#5B8343">Last Date to Apply:</strong> <?php echo htmlspecialchars($job['l_d_a']); ?></p>
                <p class="card-text"><strong style="color:#5B8343">Must Have:</strong> <?php echo htmlspecialchars($job['must_have']); ?></p>
                <p class="card-text"><strong style="color:#5B8343">Creation Date:</strong> <?php echo htmlspecialchars($job['c_date']); ?></p>
                <p class="card-text"><strong style="color:#5B8343">Posted By:</strong> <?php echo htmlspecialchars($job['post_by']); ?></p>
                <a href="managejobs.php" class="btn btn-primary-outline" style="background-color: #5B8343;color: white;">Back to Job List</a>
            </div>
        </div>
    </div>
