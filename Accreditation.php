...
$date = mysqli_real_escape_string($conn, $date);
     ...
     $sql = "INSERT INTO accredetation(file,date,session)
VALUES ('$file','$date','$session')";
if ($conn->query($sql)===TRUE) {
  echo '<script type="text/javascript">';
  echo 'setTimeout(function () { swal("SUCCESS"," Uploaded Successfully!","success")';
  echo '}, 1000);</script>'; 
}
...
if ($rowadv['pagename']=='Accredetation')
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Upload Accredetation Document Form</h4>
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                       ...
                       <form class="form" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i> Upload Accredetation Document</h4>
                                <div class="row">
                                 ...
                                 <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="session" value="" autofocus="true" class="form-control" value="" name="session">
                                        </div>
 </div>
