...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls"><b><u>View Patients</b></u> <i><u></i></u></b></h4>
 ...
 <th style="background-color:#304A7B;color: white  ">ADD RESULTS</th>

 <th style="background-color:#304A7B;color: white  ">VIEW RESULTS</th>
