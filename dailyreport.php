    ...
    <div class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Daily Staff Report</h4>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="dailylist">
              <div class="form-body">
        ...
        <label style="color:black" for="projectinput2">Select Date</label>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-get-pocket"></i> Daily Staff Report
                </button>
              </div>
            </form>
