    ...
    <div class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Lab Test Report</h4>
            ...
            <form  class="form" method="POST" action="delay.php">
              <div class="form-body">
              ...
              <div class="form-actions ">
                 <button tyle="background-color: #ffd338;color:black
                  ...
                  <i class="fa fa-check-square-o"></i> View Monthly Lab Test Report
                </button>
