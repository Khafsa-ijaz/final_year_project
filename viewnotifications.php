...
if ($rowadv['pagename']=='Manage Notifications')
{
   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Notifications List</h4>
    ...
    <div class="row">
        <div class="col-12">
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">ID</th>
                                      <th style="background-color:#304A7B;color: white ">Notification</th>
            ...
            $sql = "SELECT * FROM tnotice_board order by id ";
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Delete Selected Notification?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
