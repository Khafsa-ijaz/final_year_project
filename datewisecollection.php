...
{include('connection.php');
   ...
   $this->SetTextColor(48, 74, 123);
    $this->Cell(160,10,strtoupper($product). ' DATEWISE COLLECTION REPORT : '.$date.'***'.$date1,0,0,'C');
...
$ginti=0;
        ...
        $sql2 = "SELECT * FROM itable2 where rcvddate between '$date' and '$date1' and product='$product' ";
