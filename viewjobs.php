                                ...
                                <tr>
                                   <th style="background-color:#1090CD;color: white ">S.#</th>
                                      <th style="background-color:#1090CD;color: white "> NAME</th>
                                              ...
                                              <th style="background-color:#1090CD;color: white  ">PHONE</th>
                                                  <th style="background-color:#1090CD;color: white ">RESUME</th>
                                    <th style="background-color:#1090CD;color: white  ">COMMENTS</th>
                                             
                                       <th style="background-color:#1090CD;color: white  ">SUBMITTED AT</th>
...
<td>
         ...
         <a target='_blank' data-toggle='tooltip' title='View  detail' href=individual-job.php?id=".$row['id']."> <button type='button' class='btn btn-icon btn-info btn-sm'><i class='fa fa-eye'></i></button></a>
...
<!-- <button data-toggle='tooltip' title='Delete applicant' type='button' value=Delete id=".$row['id']." class='btn btn-icon btn-danger btn-sm cc'><i class='fa fa-trash'></i></button> -->
