...
else
{
  ...
  <a  href="projectslist">  <button  style="background-color: #0B4870 !important"   type="button"  class="btn btn-info btn-sm " >Projects List</button></a>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white" type="text" required="" autofocus="true" id="head" class="form-control" placeholder="" name="head">
                                       <?php
                        include('config.php');
                $department_query = "SELECT * FROM pr  order by id DESC";
