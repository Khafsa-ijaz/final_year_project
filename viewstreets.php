...
if ($rowadv['pagename']=='View Streets')
{
   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Streets List</h4>
    ...
    <div class="row">
        <div class="col-12">
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">S.#</th>
                                    ...
                                    <th style="background-color:#304A7B;color: white  ">Street</th>
            ...
            $sql = "SELECT * FROM   st order by project  ";
...
";
    ...
    echo "
             ...
             <a data-toggle='tooltip' title='Edit Street' href=editstreet.php?id=".$row['id']."> <button type='button' class='btn btn-icon btn-warning btn-sm'><i class='fa fa-pencil'></i></button></a>
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Delete Street?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
