...
<td>
         ...
         <a target='_blank' data-toggle='tooltip' title='Add' href=uploadfiles.php?id=".$row['id']."> <button type='button' class='btn btn-icon btn-warning btn-sm'><i class='fa fa-pencil'></i></button></a>
