...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Student Slips Print</title>
...
if ($rowadv['pagename']=='Student Slips Print')
{
   ...
   echo "<li class='active'><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
		...
		<div class="col-md-6">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Student Fee Slips Print</h4>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="studentslippdf ">
              <div class="form-body">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6">
    <label style="color: black" class=" label-control" >Registration Number</label>
    <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text" required="" name="regno" style="border-color: #967ADC" id="regid" class="form-control">
                            ...
                            <div class="col-md-6">     
             <label style="color: black"  class="label-control">Month</label>
                                  
             <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" style="border-color: #967ADC" name="monthname" required="" id="monthid" class="form-control" >
                     </select>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" class="btn btn-success btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-get-pocket"></i> Print Student Fee Slip
                </button>
              </div>
            </form>
...
<script type="text/javascript">
  var input = document.getElementById('monthid');
                      ...
                      console.log(data);
                        ...
                        if (len!=0)
                        {
                           for( var i = 0; i<len; i++){
                            ...
                            $("#monthid").append("<option value='"+feeperiod+"'>"+feeperiod+"</option>");
                          }
                          }
                          else
                          {
...
if (data=="Not found")
{
  swal("Failed...!", "Registration Number Does Not Exist!", "error");
