    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Welcome to Add New Test  Form</h4>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                        ...
                                        <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" readonly=""  name="category" id="category" class="form-control">
                                       ...
                                       <option value="0">Select Category</option>
                                         ...
                                         $sql22 = "SELECT category FROM cat";
$result22 = $conn->query($sql22);

if ($result22->num_rows > 0) {
  // output data of each row
  while($row22 = $result22->fetch_assoc()) {
          echo "<option value='".$row22['category']."''>".$row22['category']."</option>";
  }
}
                              ...
                              <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                        ...
                                        <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" readonly=""  name="sc" id="sc" class="form-control">
            ...
            ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value=""  placeholder="" id="name" name="name">
                                    </div>
                                </div>
                            </div>
  ...
  <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value=""  placeholder="" id="rr" name="rr">
                                    </div>
                                </div>
                            </div>
                              ...
                              <div style="display:none" class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-9">
                                      <input value="0" style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  class="form-control" value="0"  placeholder="" id="amount" name="amount"></input>
                                    </div>
                                </div>
                            </div>
...
if (name=='')
{
 ...
 $.ajax({
                  type:'POST',
                    url: 'savefloor2.php',
                    dataType: 'json',
                   data: {category:category,name:name,unit:unit,rr:rr,amount:amount,sc:sc},
              ...
              console.log(cd);
               ...
               console.log(data);
                          ...
                          var sc2=data[0]['sc2'];
                           ...
                           $("#sc").append("<option value='"+sc1+"'>"+sc1+"</option>");
                          $("#sc").append("<option value='"+sc2+"'>"+sc2+"</option>");
                              $("#sc").append("<option value='"+sc3+"'>"+sc3+"</option>");
                                  $("#sc").append("<option value='"+sc4+"'>"+sc4+"</option>");
