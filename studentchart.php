...
else
{
 ...
 $aa1=date("F",strtotime($date1));
      ...
      $format1=$aa3."-".$aa1."-".$aa2;
       ...
       $sqli10 = "SELECT sname FROM students where regno='$regno' and session='$session' ";
            ...
            $name=$rowww['sname'];
      ?>
                      <h4 class="card-title">Student Attendance Chart of  <i><b><?php echo $name;?></b></i> <b><i style="color:red">From: </i><u><?php echo $format?></u> <i style="color:green">TO: </i><u><?php echo $format1?></u></b></h4>
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                 ...
                 <div class="s text-center " role="" aria-label="Basic example"> 
                      <form method="POST" action="stuchartpdf">
  ...
  $count=0;
   ...
   $sqli = "SELECT * FROM attendence where regno='$regno' and session='$session' and date BETWEEN '$date' and '$date1' order by id DESC";
...
dom: 'Blfrtip',
...

        {
           extend: 'csv',
           footer: false,
           messageTop: '   Student Attendance Chart of <?php echo $name;?>From: <?php echo $format?> TO: <?php echo $format1?>'
