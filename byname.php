		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Employee Name <b><u><?php echo $name?></u></b></h4>
...
<a target="_blank" href="inactiveemployeeslist"><button  type="button" class="btn btn-danger btn-sm " data-toggle="modal" data-target="#flipInY">
      ...
      <hr style="  border-top: 2px dotted #304A7B;">
            ...
            $sql = "SELECT id,name,fname,designation,image,mob,salary,status FROM employees where name  LIKE '%$name%' order by id DESC";
