...
if ($rowadv['pagename']=='View Employees')
{
   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Employees List</h4>
    ...
    <div class="row">
        <div class="col-12">
          ...
          <!--         <div class="s text-center " role="" aria-label="Basic example">   <a target="_blank" href="employeeslist"><button style="background-color: #1090CD;color: white !important" type="button" class="btn btn-outline-warning btn-sm " >
                    Complete PDF
                  </button>
</a>

<a target="_blank" href="activeemployeeslist "><button  type="button" class="btn btn-success-outline btn-sm" data-toggle="modal" data-target="#flipInY" style="background-color:#5B8343; color: white;font-weight: bold;">
...
<a target="_blank" href="inactiveemployeeslist"><button  type="button" class="btn btn-danger btn-sm " data-toggle="modal" data-target="#flipInY">
      ...
      <hr style="  border-top: 2px dotted #5B8343;">
                        <table sty class="table table-striped table-bordered file-export">
                            <thead>
                                <tr>
                                   <th style="background-color:#1090CD;color: white ">ID</th>
                                      <th style="background-color:#1090CD;color: white ">NAME</th>
                                    <th style="background-color:#1090CD;color: white  ">FATHER NAME</th>
                                              <th style="background-color:#1090CD;color: white  ">DESIGNATION</th>
                                          <th style="background-color:#1090CD;color: white  ">IMAGE</th>
                                           <th style="background-color:#1090CD;color: white  ">MOBILE NO</th>
                                            <th style="background-color:#1090CD;color: white  ">SALARY</th>
                                             <th style="background-color:#1090CD;color: white  ">STATUS</th>
