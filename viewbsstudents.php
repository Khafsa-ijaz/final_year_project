   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing BS Students  List</h4>
    ...
    <div class="row">
        <div class="col-12">
         ...
         <a href="viewallstudents.php" ><button class="btn btn-outline-info" style="background-color:#5B8343; color: white;font-weight: bold; border:1px solid#5B8343;">MS Students</button>    </a>    
...
$(".cc").click(function(e) {
 ...
 .then((willDelete) => {
  if (willDelete) {
     $.ajax({
                url:"deletebsstudent.php?id="+del_id,
                cache:false,
