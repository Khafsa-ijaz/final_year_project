...
include('navigation.php');
 ...
 <?php include('fourteen.php');
    ...
    ?>
        ...
        <li  class=" nav-item"><a href="#"><i class="icon-layers"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Classes Section</span></a>
            <ul class="menu-content">


   <?php
                $sqladv = "SELECT pagename,link FROM menu where category='Classes Section' and status='1' and user='$rowsession[username]'";
...
if ($rowadv['pagename']=='Add New Class')
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Add New Class Form</h4>
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                       ...
                       <form class="form" method="POST">
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i> Class Info</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Class Name <span style="color:red">*</span> </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;border:1px solid #5B8343"  type="text" id="cname" autofocus="true" class="form-control" value="" name="username">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="session" value="2024-25" autofocus="true" class="form-control" value="" name="username">
                                        </div>
 </div>
                                       ...
                                       <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="projectinput1">Group <span style="color:red">*</span> </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="cgroup" value="" autofocus="true" class="form-control" value="" name="username">
                                        </div>
 </div>
                    ...
                    <div  style="display: none" class="loader"></div>
                            ...
                            <div class="form-actions">
                                ...
                                <button id="save" name="submit" style="background-color: #5B8343;color:white;border:1px solid #062F4F" type="submit" class="btn btn-outline-info ">
                                    <i class="fa fa-check"></i> Add New Class
                                </button>
                            </div>
...
if (cname!='' )
{
 $.ajax({
                  type:'POST',
                    url: 'saveclass.php',
                    dataType: 'json',
                    data: {cname:cname,cgroup:cgroup,session:session},
