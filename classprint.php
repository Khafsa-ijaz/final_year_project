...
if ($rowadv['pagename']=='Class Slips Print')
{
   ...
   echo "<li class='active'><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
	...
	<div class="row">
		<div class="col-md-6">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Class Slips Print</h4>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="slipspdf">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-money"></i> Report Requirement</h4>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label style="color:black" for="projectinput1">Select Class</label>
              <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" required="" name="classname" id="class" class="form-control">
                  <option value="0">Select Class</option>
                  <?php

                  include('connection.php');

                  $query="SELECT DISTINCT cname,id from classes where csession='$session'";
        ...
        <label style="color:black" for="projectinput2">Select Month</label>
                           <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" name="monthname" id="monthid" required="" class="form-control" >
                     </select>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" class="btn btn-success btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-get-pocket"></i> Print Class Wise Slips
                </button>
              </div>
            </form>
