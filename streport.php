         ...
         // $pdf->Cell(20,7,'MERITAL STATUS',1,0,'L',1);
             ...
             $pdf->Cell(20,7,'PROGRAM',1,0,'L',1);
                  $pdf->Cell(15,7,'CGPA',1,0,'L',1);
                           $pdf->Cell(30,7,'TOTAL MARKS',1,0,'L',1);
             $pdf->Cell(30,7,'OBTAINED MARKS',1,0,'L',1);
...
$pdf->CellFitScale(20,6,$row['mobileno'],1,0,'L');
$pdf->CellFitScale(30,6,$row['program'],1,0,'L');

$pdf->CellFitScale(30,6,$row['dob'],1,0,'L');

$pdf->CellFitScale(58,6,$row['cgpa'],1,0,'L');
$pdf->CellFitScale(50,6,$row['Total_Marks'],1,0,'L');
$pdf->CellFitScale(50,6,$row['obtained_marks'],1,0,'L');
$pdf->CellFitScale(20,6,$row['session'],1,0,'L');
$pdf->CellFitScale(30,6,$row['address'],1,0,'L');
