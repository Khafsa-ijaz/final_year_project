...
if ($rowadv['pagename']=='View Vendors')
{
...
if ($rowadv['pagename']=='Balance Report')
{
...
$a1=date("F",strtotime($date1));
      ...
      $format1=$a3."-".$a1."-".$a2;
                  ...
                  ?>
                     <h4 class="card-title"><span style="color:green"><b><u><?php echo $iname?></span></u></b> Ledger Between <b><i style="color:red">Date: <u><?php echo $format?>***<?php echo $format1?></i></u></h4>
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                 ...
                 <div class="s text-center " role="" aria-label="Basic example"> 
                      <form method="POST" action="pdfvenled.php">
     <input type="hidden" value="<?php echo $iname?>" name="iname">
                                ...
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">S.#</th>
                                    ...
                                    <th style="background-color:#304A7B;color: white ">Date</th>
                                      ...
                                      <th style="background-color:#304A7B;color: white ">Description</th>
                                      
                                      
                                      
                                    <th style="background-color:#304A7B;color: white  ">Credit</th>
                                          <th style="background-color:#304A7B;color: white  ">Debit</th>
            
                                                <th style="background-color:#304A7B;color: white  ">Date/Time</th>
                                                  <th style="background-color:#304A7B;color: white  ">By</th>
  ...
  $count=0;
            ...
            $sql = "SELECT * FROM ven where iname='$iname' and date between '$date' and '$date1' ";
   ...
   echo "
                  ...
                  <td><b>".number_format($row['amountin'])."</b></td>
                  <td>".number_format($row['amountout'])."</td>
...

        {
           ...
           footer: false,
              exportOptions: {
                   ...
                   messageTop: '<?php echo $iname?> Ledger Report between <?php echo $format?>***<?php echo $format1?>'
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Delete Vendor Transaction?Bank Will Also Reverse this Transaction",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
