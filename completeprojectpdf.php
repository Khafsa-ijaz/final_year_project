...
$prname=$_POST['project'];
   ...
   $this->SetTextColor(0,0,0);
    ...
    $this->Cell(60);
    $this->Cell(160,10,'WHOLE PROJECT REPORT',0,0,'C');
    $this->Ln(7);
    }
    else{
 ...
 $pdf->Cell(15);
  ...
  $pdf->Cell(20,7,'Plot Number',1,0,'C',1);
    ...
    $pdf->Cell(25,7,'Plot Area',1,0,'L',1);
       $pdf->Cell(30,7,'Plot Size',1,0,'L',1);
          $pdf->Cell(35,7,'TOTAL COST PRICE',1,0,'L',1);
             $pdf->Cell(40,7,'SPECIAL DISCOUNT',1,0,'L',1);
                $pdf->Cell(45,7,'PRICE AFTER DISCOUNT',1,0,'L',1);

 $pdf->Ln(7);
$counting=0;
$sql12 = "SELECT * FROM plot where block='$block' and st='$street' order by pno asc";
 ...
 $pdf->SetFont('Arial','',7);
   ...
   ++$tc;
       ...
       $pdf->CellFitScale(30,6,$row12['km'],1,0,'L');
$pdf->CellFitScale(35,6,$row12['totalcost'],1,0,'L');
$pdf->CellFitScale(40,6,$row12['sd'],1,0,'L');
$pdf->CellFitScale(45,6,$row12['cpd'],1,0,'L');
