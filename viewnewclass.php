		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Classes  List</h4>
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#1090CD;color: white ">S.#</th>
                                      <th style="background-color:#1090CD;color: white ">CLASS NAME</th>
                                    <th style="background-color:#1090CD;color: white  ">CLASS GROUP</th>
