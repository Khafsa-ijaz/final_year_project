...
if ($rowadv['pagename']=='Student Progress Report')
{
...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Student Progress Report</h4>
         ...
         <form class="form form-horizontal" method="POST" action="pdfstudentprogress ">              <div class="form-body">
 ...
 <div class="col-md-6">
                  ...
                  <div id="second" class="form-group">
                    <input style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"   required="" name="register" class="form-control" id="register2" placeholder="">
                  </div>
                </div>
                </div>
  ...
  ?>
                ...
                <button name="submit"   onclick="return mess()" type="submit" value=""  class="btn btn-warning btn-min-width btn-glow mr-1 mb-1 " />Student Progress Report</button> 
                </form>
