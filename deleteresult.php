...
if ($rowadv['pagename']=='Delete Result')
{
...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Delete Result</h4>
         ...
         <form class="form form-horizontal" method="POST" action="markresult">              <div class="form-body">
             ...
             <div class="col-sm-6">
                 ...
                 <div  class="form-group">
                   <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;"  type="number" style="border-color:#17A2B8" required="" name="termname" class="form-control" id="termname" >
                       <?php
  ...
  ?>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                 ...
                 <div  class="form-group">
                    <select  style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;"  type="text"  style="border-color:#17A2B8" required="" name="classname"
                    class="form-control" id="classname" placeholder="Enter Class Name">
          <?php
          include('connection.php');
  $sql = "SELECT DISTINCT class FROM result_entry where session='$session' order by r_id";
  $result = $conn->query($sql);
  ...
  if ($result->num_rows > 0) {
    ...
    ?>
        ...
        <option value="<?php echo $row['class']?>"><?php echo $row120['cname']?></option>";
     <?php
    }
  }
  $conn->close();
  ?>
                ...
                <div class="col-sm-6">
                   <div class="form-group">
                  <label style="color:black">Select Subject</label>
                 <div  class="form-group">
                            
                    <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" type="text"  required="" name="subject" class="form-control" id="subjectname" >
                ...
                <button name="submit"   onclick="return mess()" type="submit" value=""  class="btn btn-danger cc btn-min-width btn-glow mr-1 mb-1 " />Delete Result</button> 
...
$(".cc").click(function(e) {
 ...
 var tt= $('#termname').val();
  var ss= $('#subjectname').val();
console.log(cc);
console.log(ss);
console.log(tt);
 swal({
  title: "Are you sure to Delete Class Result?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
     ...
     $.ajax({
              ...
              //  dataType: 'json',
                success:function(result){
                    console.log(result);
                   swal("Subject Result Has Been Deleted Successfully",{icon: "success"});
                   location.reload();
    }
              });
}
