...
if ($result->num_rows > 0) {
 ...
 $lname=$row['lname'];
  $v8=$row['file'];
 $image2="../html/ltr/vertical-menu-template/uploads/$v8";
 $email=$row['email'];
 $phone=$row['phone'];
...
<section class="w3l-about-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>Faculty</h2>
      <p><a href="index12.php">Home</a> &nbsp; / &nbsp;<a href="faculty.php">Faculty</a> &nbsp; / &nbsp;<?php echo $fname ?> <?php echo $lname?>  </p>
    </div>
  </div>
</section>
        ...
        <div class="row row-eq-height">
            ...
            <div class="col-lg-12 col-md-9">
                <div class="box details" style="border:1px solid #5B8343;">
                    ...
                    <div  class="col-lg-4 col-md-3" style="background-color: #5B8343; color:white; font-size: 30px; font-weight: bold; "><?php echo $fname?>  <?php echo $lname?></div>                  
...
<td colspan="2" bgcolor="#ECE9D8"><?php echo $fname ?> <?php echo $lname ?></td>
<td rowspan="6" align="right" width="15%"><img src='<?php echo $image2 ?>' width="250px" height="250px"></td>
</tr>
<tr>
<td>Email</td>
<td colspan="2"><a href="goharrehman@wuajk.edu.pk"><?php echo $email ?></a></td>
</tr>
<tr>
<td bgcolor="#ECE9D8">Phone</td>
<td colspan="2" bgcolor="#ECE9D8"><?php echo $phone ?></td>
</tr>
<!-- <tr>
<td>Research Area</td>
...
<td colspan="3" bgcolor="#ECE9D8"><?php echo $designation ?></td>
</tr>
<tr>
<td>Department</td>
...
<td colspan="3" bgcolor="#ECE9D8">Women University Of Ajk Bagh</td>
</tr>
<tr>
...
$sql = "SELECT * FROM experience where fid='$id'";
$result = $conn->query($sql);
...
?>
<tr>
<td colspan="4" bgcolor="#C2D3FC"><strong>PROJECTS</strong></td>
</tr>
<tr>
<td bgcolor="#ECE9D8">PROJECT</td>
<td bgcolor="#ECE9D8">FUNDED BY</td>
<td bgcolor="#ECE9D8">AMOUNT</td>
<td bgcolor="#ECE9D8">YEAR</td>
</tr>

<?php

$sql = "SELECT * FROM projects where fid='$id'";
$result = $conn->query($sql);
...
?>
<tr>
<td colspan="4" bgcolor="#C2D3FC"><strong>SUPERVISION</strong></td>
</tr>
<tr>
<td bgcolor="#ECE9D8">STUDENT NAME</td>
<td bgcolor="#ECE9D8" colspan="2">TITLE</td>
<td bgcolor="#ECE9D8"colspan="2"  width="13%">STATUS</td>
</tr>

<?php

$sql = "SELECT * FROM supervision where fid='$id'";
$result = $conn->query($sql);
...
?>
<tr>
<td colspan="4" bgcolor="#B3CFFC"><strong>RESPONSIBILITIES</strong></td>
</tr>
<tr>
<td   bgcolor="#ECE9D8" colspan="2">RESPONSIBILITY</td>
<td colspan="2" bgcolor="#ECE9D8" >TOR</td>

</tr>

<?php
       
    $sql = "SELECT * FROM responsibility where fid='$id'";
$result = $conn->query($sql);
...
<td colspan='2'>$tor</td>
  ...
  ?>
 <tr>
<td colspan="4" bgcolor="#C2D3FC"><strong>BOOKS/CHAPTERS</strong></td>
</tr>
<tr>
<td bgcolor="#ECE9D8" colspan="2">BOOK/CHAPTER</td>
<td bgcolor="#ECE9D8" colspan="2">LINK</td>

</tr>

<?php

$sql = "SELECT * FROM book where fid='$id'";
$result = $conn->query($sql);
...
<tr>
<td colspan="4" bgcolor="#ECE9D8"><strong> JOURNALS:</strong></td>
</tr>
</tbody>
</table>
<table class="table table-bordered table-striped" width="674">
...
<tr>
    <?php
         $count=1;
    $sql = "SELECT * FROM Journals  where fid='$id'";
$result = $conn->query($sql);
...
<p background-color="#ECE9D8"><strong>CONFERENCES:</strong></p>
<table class="table table-bordered table-striped" width="674">
<tbody>
<tr>
    <?php
        $count=1;
    $sql = "SELECT * FROM Conferences  where fid='$id'";
$result = $conn->query($sql);
...
<!-- <p bgcolor="#ECE9D8"><strong>BOOKS/CHAPTERS:</strong></p>
<table class="table table-bordered table-striped" width="674">
<tbody>
<tr>
    <?php
