 ...
 <head>
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Sessions List</h4>
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">S.#</th>
                                      <th style="background-color:#304A7B;color: white ">Sessions</th>
                                        
                                         <th style="background-color:#304A7B;color: white  ">Status</th>
                                                <th style="background-color:#304A7B;color: white  ">Activate</th>  <th style="background-color:#304A7B;color: white  ">De-Activate</th>
  ...
  $count=0;
   ...
   if ($s=='0')
                  {
                    echo "
                 <td style='font-size:11px'><span class='badge badge-pill badge-danger'>In-Active</span></td>";
               }
               
               if ($s=='1')
                  {
                    echo "
                <td style='font-size:11px'><span class='badge badge-pill badge-success'>Active</span></td>";
               }
           ...
           echo "
                     <td>
                                    ...
                                    <div class='btn-group' role='group' aria-label='Basic example'>
                                             ...
                                             <button type='button' value=Delete id=".$row['id']." class='btn btn-icon btn-outline-success cc btn-sm '><i class='fa fa-toggle-off'></i></button>
                  ...
                  echo "
                     <td>
                                    ...
                                    <div class='btn-group' role='group' aria-label='Basic example'>
                                             ...
                                             <button type='button' value=Delete id=".$row['id']." class='btn btn-icon btn-outline-danger ccc btn-sm '><i class='fa fa-toggle-on'></i></button>
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Activate Session?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
 .then((willDelete) => {
  if (willDelete) {
     $.ajax({
                url:"activesession.php?id="+del_id,
                cache:false,
...
$(".ccc").click(function(e) {
 ...
 var del_id= $(this).attr('id');
 swal({
  title: "Are You Sure to De-Activate Session?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
 .then((willDelete) => {
  if (willDelete) {
     $.ajax({
                url:"deactivesession.php?id="+del_id,
                cache:false,
                success:function(result){
