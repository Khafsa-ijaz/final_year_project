...
$sql = "SELECT status FROM menu where category='Attendance Section' and user='$rowsession[username]'";
  ...
  while($row = $result->fetch_assoc()) {
    ...
    else
    {
        echo " 
            ...
            <li  class='nav-item'><a href='#'><i class='fa fa-clock-o'></i><span class='menu-title' data-i18n='nav.page_layouts.main'>Attendance Section</span></a>
