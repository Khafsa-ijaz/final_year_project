      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link" href="gallery.php"><b style="color:#5b8343">Gallery</b></a>
          </li>
           </li>
            <li class="nav-item">
...
<section class="w3l-service-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>CS Gallery</h2>
      <p><a href="index12.php">Home</a> &nbsp; / &nbsp; Gallery</p>
    </div>
  </div>
</section>
			...
			<div class="container py-md-3">
			   ...
			   <div class="fea-gd-vv text-center row">
					...
					<div class="float-top col-lg-4 col-md-6">	
							<a href="assets/images/im (1).jpeg" data-lightbox="image11"><img src="assets/images/im (1).jpeg" class="img-responsive" alt=""></a>
							<div class="float-lt feature-gd">	
									<h3><a href="#">Red crecent Festival </a> </h3>
					...
					<div class="float-top col-lg-4 col-md-6 mt-md-0 mt-5">	
							<a href="assets/images/im (2).jpeg" data-lightbox="roadtrip"><img src="assets/images/im (2).jpeg" class="img-responsive" alt=""></a>
              <a href="assets/images/im (3).jpeg" data-lightbox="roadtrip"></a>
              <a href="assets/images/im (6).jpeg" data-lightbox="roadtrip"></a>

							<div class="float-lt feature-gd">	
									<h3><a href="#">HEC TEST</a> </h3>
									<p>HEC Test 2023 held  in virtual university </p>
									</div>
						</div>
						<div class="float-top col-lg-4 col-md-6 mt-lg-0 mt-5">	
								<a href="#"><img src="assets/images/im (3).jpeg" class="img-responsive" alt=""></a>
								<div class="float-lt feature-gd">	
										<h3><a href="#">Sports Week</a> </h3>
										<p> Consectetur adipisicingelit, sed do eiusmod tempor incididunt ut labore et.dolor sit amet </p>
									</div>
						</div>
						<div class="float-top col-lg-4 col-md-6 mt-5">	
							<a href="#"><img src="assets/images/im (6).jpeg" class="img-responsive" alt=""></a>
							<div class="float-lt feature-gd">	
									<h3><a href="#"> Festivities</a> </h3>
									<p> Consectetur adipisicingelit, sed do eiusmod tempor incididunt ut labore et.dolor sit amet </p>
									</div>
					</div>
					<div class="float-top col-lg-4 col-md-6 mt-5">	
							<a href="#"><img src="assets/images/im (7).jpeg" class="img-responsive" alt=""></a>
							<div class="float-lt feature-gd">	
									<h3><a href="#">Black Day</a> </h3>
									<p> Consectetur adipisicingelit, sed do eiusmod tempor incididunt ut labore et.dolor sit amet </p>
									</div>
						</div>
						<div class="float-top col-lg-4 col-md-6 mt-5">	
								<a href="#"><img src="assets/images/im (9).jpeg" class="img-responsive" alt=""></a>
								<div class="float-lt feature-gd">	
										<h3><a href="#">CS Stall</a> </h3>
										<p> Consectetur adipisicingelit, sed do eiusmod tempor incididunt ut labore et.dolor sit amet </p>
									</div>
						</div>	
              <div class="float-top col-lg-4 col-md-6 mt-5">  
                <a href="#"><img src="assets/images/im (10).jpeg" class="img-responsive" alt=""></a>
                <div class="float-lt feature-gd"> 
                    <h3><a href="#">Seniors Represntation in Farewell</a> </h3>
                    <p> Consectetur adipisicingelit, sed do eiusmod tempor incididunt ut labore et.dolor sit amet </p>
                  </div>
            </div>  
