...
if ($rowadv['pagename']=='Absent/Leave Report')
{
...
else
{
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
    ...
    <?php
      ...
      $format=$a3."-".$a1."-".$a2;
      ?>
                      <h4 class="card-title">Staff Absent/Leave List  <b><i style="color:red">Date: </i><u><?php echo $format?></u> <i style="color:green"></i></u></b></h4>
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                 ...
                 <div class="s text-center " role="" aria-label="Basic example"> 
                      <form method="POST" action="listleaveabsentpdf">
  ...
  $count=0;
   ...
   $sqli = "SELECT emp_id,status FROM tattendence where  status='Absent' or status='Leave' and date='$date' order by emp_id ASC ";
...
dom: 'Blfrtip',
...

        {
           extend: 'csv',
           footer: false,
                messageTop: 'Staff Absent/Leave List  Date:<?php echo $format?>'
