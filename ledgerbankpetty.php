...
include('navigation.php');
 ...
 <?php include('third.php');
    ?>
      ...
      <li  class=" nav-item"><a href="#"><i class="icon-layers"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Vendor Section</span></a>
            <ul class="menu-content">


   <?php
                $sqladv = "SELECT pagename,link FROM menu where category='Vendor Section' and status='1' and user='$rowsession[username]'";
...
$a1=date("F",strtotime($date1));
      ...
      $format1=$a3."-".$a1."-".$a2;
                  ...
                  ?>
                     <h4 class="card-title"><span style="color:green"><b><u><?php echo $bankname?></span></u></b> Vendor Bills History</i></u></h4>
 ...
 <input type="hidden" value="<?php echo $bankname?>" name="bankname">
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">S.#</th>
                                    ...
                                    <th style="background-color:#304A7B;color: white ">INVOICE NO</th>
                                     <th style="background-color:#304A7B;color: white ">VENDOR NAME</th>
                                          <th style="background-color:#304A7B;color: white ">GST</th>
  ...
  $count=0;
         ...
         $sql = "SELECT * FROM bill order by date,id";
         ...
         <td><b>".$row['date']."</b></td>
                     ...
                     <td>   <a target='_blank'  data-toggle='tooltip' title='Print Bill' href=vendorbill2.php?vendor=".$row['vendor']."&inv=".$row['inv']."> <button type='button' class='btn btn-icon btn-outline-success btn-sm'><i class='fa fa-print'></i></button></a></td>
               <td>      <div style='text-center'  class='btn-group' role='group' aria-label='Basic example'>
                  
                      <a  data-toggle='tooltip' title='Edit Inventory' href=itab.php?vendor=".$row['vendor']."&inv=".$row['inv']."> <button type='button' class='btn btn-icon btn-outline-dark btn-sm'><i class='fa fa-pencil'></i></button></a>
                  
                  <button data-toggle='tooltip' title='Delete' type='button' value=Delete id=".$row['id']." class='btn btn-icon btn-outline-danger btn-sm cc'><i class='fa fa-trash'></i></button></td>
                  </div>
           ...
           footer: false,
              exportOptions: {
                    ...
                    rows: ':visible' 
                             ...
                             messageTop: '<?php echo $bankname?> Ledger Report between <?php echo $format?>***<?php echo $format1?>'
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Delete Complete Bill?? All Inventory Against this bill will be deleted Also?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
