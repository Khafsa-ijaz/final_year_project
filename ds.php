        ...
        <div class="container py-md-5">
            <div class="cwp4-two row">
                ...
                <div class="cwp4-text col-lg-8">
                        <h3 style="color:#1090CD; font-size:30px">Bachelor Of Science In Data Science(BSDS)</h3>
                        <h5 style="color:#5B8343 ; font-weight:bold;">Introduction</h5>
                         ...
                         <p style="font-size:15px">    The objectives of the program are to provide broad and basic education in Data Science. The students will acquire sufficient knowledge of analytics, visualization and governance of data. This distinctive mixture of technology and business will help the students in building a future-oriented career in a global environment. This program will cover general business intelligence which will boost the students’ employability.
...
<tr>
<td></td>
<td>Civics & Community Engagement 
