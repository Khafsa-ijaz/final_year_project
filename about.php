...
<section class="w3l-about-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>About Us</h2>
      <p><a href="index12.php">Home</a> &nbsp; / &nbsp; About</p>
    </div>
  </div>
</section>
...
Keeping in mind the absolute dependence of the contemporary world requirements over Information technology the program offered by the department is tailored towards producing computer scientists capable of achieving new heights in innovation and enhancement of technology to provide the world an even better tomorrow. Our program is accredited by the Higher Education commission and to achieve excellence we strictly follow the standard curriculum guidelines as laid down by the HEC.
                ...
                <div class="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-5">
                    <img src="https://wuajk.edu.pk/uploads//2021/banner_new_uni.jpg" class="img-fluid" alt="" style="width:100%; height: 70%;" />
                </div>
            </div>
        </div>
    </div>
		...
		<div class="grid top-bottom py-5">
			<div class="container py-md-5">
				<div class="heading text-center mx-auto">
					<h3 class="head"  style="color:#1090CD">Why Choose Our Institution</h3>
				...
				<div class="middle-section row mt-5 pt-3">
					<div class="three-grids-columns col-lg-3 col-sm-6 text-center"  >
						<div class="icon" > <span class="fa fa-graduation-cap" aria-hidden="true" style="background-color: #5B8343; color:white;"></span></div>
						<h4>Scholarship Facility</h4>
						<p></p>
					</div>
					<div class="three-grids-columns col-lg-3 col-sm-6 mt-sm-0 mt-5 text-center">
						<div class="icon"> <span class="fa fa-user" aria-hidden="true" style="background-color: #5B8343; color: white"></span></div>
						<h4>Skilled Lecturers</h4>
						<p></p>
					</div>
					<div class="three-grids-columns col-lg-3 col-sm-6 mt-lg-0 mt-5 text-center">
						<div class="icon"> <span class="fa fa-book" aria-hidden="true" style="background-color: #5B8343; color: white"></span></div>
						<h4> Library & Store</h4>
						<p></p>
					</div>
					<div class="three-grids-columns col-lg-3 col-sm-6 mt-lg-0 mt-5 text-center">
						<div class="icon"> <span class="fa fa-bed" aria-hidden="true" style="background-color: #5B8343; color: white;"></span></div>
    ...
    <div id="content-with-photo4-block" class="pt-5"> 
        <div class="container py-md-5">
            <div class="cwp4-two row">
                ...
                <div class="cwp4-text col-lg-6">
                        <h3 style="color:#1090CD; font-size:25px;">Message From The Head of Department</h3>
                        <h6 style="color:#5B8343">Welcome to CS&IT Department of WUBAJK</h6>
                    <p style="font-size: 15px;">Welcome to our Department of Computer Sciences & Information Technology. The information explosion together with developments in technology have led to the convergence of traditional communication media and turned the Information Era into a web of integrated communication connections.  For Computer Scientists the current era is full of excitement and challenges as the discipline is now widely recognized to be an essential source of tools and techniques for advancements in nearly all spheres of human endeavour. Information Technology/ Computer Science is a fascinating subject, and one that is now indispensable in our lives. Almost every aspect of modern life involves computing – from mobile phones, TVs, planes, trains and cars, to gaming, security and medicine. Every organization’s payroll, customer records and finances are held electronically, sometimes containing millions and millions of records. The digital world is really upon us. Looking to the future, initiatives such as cloud computing will connect us all through small portable devices, enhancing social networking and allowing us to exchange audio and video data from our daily lives.Keeping in mind the absolute dependence of the contemporary world requirements over Computer Science the program offered by the department is tailored towards producing computer scientists capable of achieving new heights in innovation and enhancement of technology to provide the world an even better tomorrow. 

                     Come join this exciting new world of Computer Science in all its facets.
                     <br><br>

<b>Dr. Gohar Rehman Chughtai <br>
Head of Department of CS/IT</b>
                ...
                <div class="cwp4-image col-lg-6 pl-lg-5 mt-lg-0 mt-5">
                    <img src="sir.jpeg" class="img-fluid" alt="" style="width:100%; height: 70%;" />
                </div>
            </div>
        </div>
    </div>
