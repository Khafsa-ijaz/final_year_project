...
$sql = "SELECT status FROM menu where category='Students Section' and user='$rowsession[username]'";
  ...
  while($row = $result->fetch_assoc()) {
    ...
    else
    {
        echo " 
            ...
            <li  class='nav-item'><a href='#'><i class='fa fa-graduation-cap'></i><span class='menu-title' data-i18n='nav.page_layouts.main'>Students Section</span></a>
