...
<section class="w3l-about-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>Our Mission</h2>
      <p><a href="index12.php">Home</a> &nbsp; / &nbsp; Mission</p>
    </div>
  </div>
</section>
        ...
        <div class="container py-md-5">
            <div class="cwp4-two row">
                    ...
                    <div class="cwp4-text col-lg-8">
                        <h3 style="color:#1090CD; font-size:25px">Our Mission</h3>
                        <h6 style="color:#5B8343">Welcome to CS&IT Department of WUBAJK</h6>
                    <p style="font-size:16px">By promoting excellence in education, research, and social engagement, the Department of Computer Science and Technology is dedicated to create a community of empowered women leaders who actively contribute to the positive transformation of society, embracing the challenges of today and shaping the possibilities of tomorrow. We intend to produce computer science graduates, who will not only improve their technical and economic standing, but will also, contribute to the economic, scientific, a nd social development of the state of Azad Jammu and Kashmir and Pakistan.
