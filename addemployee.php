...
if ($rowadv['pagename']=='Add Employees')
{
...
else
{
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Add New Employee Form</h4>
 ...
 <a target="_blank" href="employeeheads "> <button type="button" style="background-color: #5B8343 !important" class="btn btn-info btn-sm " ><i class="fa fa-plus"></i>&nbspAdd Heads</button></a>
   <a target="_blank" href="viewemployees"> <button type="button"  style="background-color: #1090CD !important"      class="btn btn-warning btn-sm " ><i class="fa fa-users"></i>&nbspEmployees List</button></a>
                    ...
                    <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;border:1px solid #5B8343"  type="text" id="name" autofocus="true" class="form-control" value="" name="username">
                                        </div>
                      ...
                      <div class="col-md-6">
                               ...
                               <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Employee ID <span style="color:red">*</span> </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="emp_id" autofocus="true" class="form-control" value="" name="emp-id">
                                        </div>
 </div>
           ...
           <div class="col-md-6">
                       ...
                       <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="date" id="bdate" autofocus="true" class="form-control" value="<?php echo date("Y-m-d")?>" name="username">
                           ...
                           <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="number" id="mob" autofocus="true" class="form-control" value="92" name="username" maxlength="11">
    ...
    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="number" id="en1" autofocus="true" class="form-control" value="92" name="username">
                                            <p style="color:#5B8343;"><b>Must Start with 92</b></p>
                                        </div>
 </div>
      ...
      <!--      <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Emergency No 2</label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="number" id="en2" autofocus="true" class="form-control" value="92" name="username">
                                             <p style="color:#5B8343;"><b>Must Start with 92</b></p>
                                        </div>
 </div> -->                   
          ...
          <!--         <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Emergency No 3</label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="number" id="en3" autofocus="true" class="form-control" value="92" name="username">
                                            <p style="color:#5B8343;"><b>Must Start with 92</b></p>
                                        </div>
 </div> -->
                 ...
                 <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="marital" autofocus="true" class="form-control" value="" name="username">
                        ...
                        <option value="Single">Single</option>
                         ...
                         <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="vaccine" autofocus="true" class="form-control" value="" name="username">
  ...
  <h4 class="form-section"><i class="ft-user"></i> Academics</h4>
                <div class="row">

                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Qualification</label>
                                            <select s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;" type="text" id="qualification" autofocus="true" class="form-control" value="" name="username">
                                                <?php
                        include('config.php');
                $department_query = "SELECT * FROM employeeheads where category='qualification'";
            ...
            ?>
                    ...
                    <p style="color:#5B8343"><b>You can Add More by using ADD HEADS option at top <b></b></b></p>
                                        </div>
    ...
    <!--   <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="department" autofocus="true" class="form-control" value="" name="username">
            ...
            <p style="color:#5B8343"><b>You can Add More by using ADD HEADS option at top <b></b></b></p>
                     ...
                     <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select s style="box-shadow: 0 0 4px white;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="designation" autofocus="true" class="form-control" value="" name="username">
                                                 <?php
                        include('config.php');
                $department_query = "SELECT * FROM employeeheads where category='designation'";
                $stmt = $conn->prepare($department_query);
                $stmt->execute();
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                echo "<option value='".$row['headname']."''>".$row['headname']."</option>";
      ...
      <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Join Date</label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="date" value="<?php echo date("Y-m-d")?>" id="jdate" autofocus="true" class="form-control" value="" name="username">
                                        </div>
 </div>
                     ...
                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Salary</label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="number" id="salary" autofocus="true" class="form-control" value="0" name="username">
                                        </div>
 </div>
                    ...
                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" id="status" autofocus="true" class="form-control" value="" name="username">
                        ...
                        <option value="In-Active">In-Active</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">In-Active Date</label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="date" id="iad" autofocus="true" class="form-control" value="<?php echo date("Y-m-d")?>" name="username">
                                        </div>
 </div>
      ...
      <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color:  #1090CD;color:white ; border:1px solid  #5B8343;"  type="text" value="" id="remarks" autofocus="true" class="form-control" value="" name="username">
                                        </div>
 </div>
 ...
 $.ajax({
                  type:'POST',
                    url: 'saveemployee.php',
                     dataType: 'json',
                    data: {name:name,fname:fname,emp_id:emp_id,cnic:cnic,address:address,bdate:bdate,mob:mob,jdate:jdate,qualification:qualification,department:department,designation:designation,salary:salary,status:status,en1:en1,en2:en2,en3:en3,marital:marital,gender:gender,vaccine:vaccine,remarks:remarks,iad:iad},
