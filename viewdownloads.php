...
if ($rowadv['pagename']=='View Downloads')
{
        ...
        <div class="col-md-12">
            <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Downloads List</h4>
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#1090CD;color: white ">S.#</th>
                                    ...
                                    <th style="background-color:#1090CD;color: white  ">Uploaded File</th>
                                    ...
                                    <th style="background-color:#1090CD;color: white  ">VACCINE STATUS</th>
                                              <th style="background-color:#1090CD;color: white  ">QUALIFICATION</th>
                                    ...
                                    <th style="background-color:#1090CD;color: white  ">INACTIVE DATE</th>
                                              <th style="background-color:#1090CD;color: white  ">REMARKS</th>
...
<td>
         ...
         <a target='_blank' data-toggle='tooltip' title='View' href=viewfile.php?id=".$row['id']."> <button type='button' class='btn btn-icon btn-info btn-sm'><i class='fa fa-eye'></i></button></a>



                    

                             <button data-toggle='tooltip' title='Delete file' type='button' value=Delete id=".$row['id']." class='btn btn-icon btn-danger btn-sm cc'><i class='fa fa-trash'></i></button>
...
$(".cc").click(function(e) {
 ...
 .then((willDelete) => {
  if (willDelete) {
     $.ajax({
                url:"deletedownloads.php?id="+del_id,
                cache:false,
