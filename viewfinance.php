...
if ($rowadv['pagename']=='View Finance Heads')
{
...
else
{
 ...
 <?php include('fourteen.php');
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Employees Heads List</h4>
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">S.#</th>
                                      <th style="background-color:#304A7B;color: white ">HeadName</th>
  ...
  $count=0;
   ...
   $sql = "SELECT DISTINCT iname FROM income  order by iname ";
...
$sql3 = "SELECT id,type FROM income where iname='$row[iname]' order by id ASC LIMIT 1";
           ...
           echo " <tr>
              ...
              <td>
                      <div class='btn-group' role='group' aria-label='Basic example'>
                                                                   ...
                                                                   <a target='_blank' data-toggle='tooltip' title='Edit' href=edittf.php?id=".$id."> <button type='button' class='btn btn-icon btn-outline-dark btn-sm'><i class='fa fa-pencil'></i></button></a>
                                       
                                        <button type='button' value=Delete id='".$row['iname']."' class='btn btn-icon btn-danger cc btn-sm  '><i class='fa fa-trash'></i></button>
                                        </div>
                     </td>
...
console.log(del_id);
 ...
 swal({
  title: "Are You Sure to Delete Finance Head?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
