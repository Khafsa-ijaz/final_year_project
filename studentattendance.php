    ...
    <div class="col-md-6">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">School Wise Attendance</h4>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="studentmark">
              <div class="form-body">
        ...
        <label style="color:black" for="projectinput2">Select Date</label>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-get-pocket"></i> Mark Schoolwise Attendance 
                </button>
              </div>
            </form>
          ...
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Classwise Attendance</h4>
                  <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
              <div class="heading-elements">
                      <ul class="list-inline mb-0">
                        <li style="color:black"><a data-action="collapse"><i class="ft-minus"></i></a></li>
          ...
          <div class="card-body">
            ...
            <form class="form" method="POST" action="classwisemark">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-money"></i> Report Requirement</h4>
                <div class="row">
                  <div class="col-md-12">
                ...
                <select style="box-shadow: 0 0 4px #333D47;background-color: #4C6586;color:white;" id="curr_class" name="curr_class" class="form-control">
                        ...
                        <?php
                        include('config.php');
                $department_query = "SELECT * FROM classes where csession='$session' order by ID DESC";
        ...
        <label style="color:black" for="projectinput2">Select Date</label>
              ...
              <div class="form-actions">
                 ...
                 <button type="submit"  id="save" class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-get-pocket"></i> Mark Classwise Attendance
                </button>
              </div>
            </form>
