...
if ($rowadv['pagename']=='Collection Report')
{
   ...
   echo "<li class='active'><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
	...
	<div class="row">
      ...
      ?>
                    <h4 class="card-title">Fees Collection <b><i style="color:red">Date: </i><u><?php echo $format?></u> <i style="color:green">Deposit In: </i><u><?php echo $type?></u></b></h4>
  ...
  $sum=0;
            ...
            $sql = "SELECT billno,curr_class,regno,sname,payablebdd,payableadd,rcvdamt,balamt FROM fees where rcvddate='$date' and rcvdvia='$type' order by curr_class DESC";
            ...
            // output data of each row
             while($row = mysqli_fetch_assoc($result))  {
                    $sum=$row['rcvdamt']+$sum;
            $cl=$row['curr_class'];
            $sql1 = "SELECT cname FROM classes where id='$cl'";
...
if ($result1->num_rows > 0) {
 ...
 $cname=$row1['cname'];
           ...
           echo " <tr>
              <td>".++$count."</td>
               ...
               <td>".$cname."</td>
                  ...
                  <td>".number_format($row['rcvdamt'])."</td>
           ...
           ?>
            <h5 class="text-center" style="color:green"><b><i>Total Collection of <span style="color:red">Date <?php echo $format?></span> is Rs <?php echo number_format($sum)?></i></b></h5>
                            </tfoot>
                          </tbody>
           ...
           footer: false,
              exportOptions: {
                    ...
                    rows: ':visible' 
                           ...
                           messageTop: 'Fees Collection Date- <?php echo $format?> Deposit In- <?php echo $type?>'
