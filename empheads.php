...
else
{
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Add Head Form</h4>
  ...
  <a  href="viewheads">  <button  style="background-color: #1090CD !important"   type="button"  class="btn btn-info btn-sm " >Heads List</button></a>
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                        ...
                        <div class="form-body">
                          <h4 sty class="form-section" style="color: black" ><i class="fa fa-user"></i> Category</h4>
                          <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="projectinput2">Head</label>
                       <select style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white" id="category" name="category" class="form-control">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="projectinput1">Head Name</label>
                      <input style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white" type="text" required="" autofocus="true" id="head" class="form-control" placeholder="" name="head">
                    </div>
                  </div>
                       ...
                       <button  style="background-color:#5B8343;color:white;border:1px solid #1090CD"  id="save"  type="submit" class="btn btn-outline-info " >
