...
$sql = "SELECT status FROM menu where category='Employees Section' and user='$rowsession[username]'";
  ...
  while($row = $result->fetch_assoc()) {
    ...
    else
    {
        echo " 
            ...
            <li  class='nav-item'><a href='#'><i class='fa fa-user'></i><span class='menu-title' data-i18n='nav.page_layouts.main'>Employees Section</span></a>
