...
$sql = "SELECT status FROM menu where category='Search Section' and user='$rowsession[username]'";
  ...
  while($row = $result->fetch_assoc()) {
    ...
    else
    {
        echo " 
            ...
            <li  class='nav-item'><a href='#'><i class='fa fa-search'></i><span class='menu-title' data-i18n='nav.page_layouts.main'>Search Section</span></a>
