...
echo '</script>';
           ...
           $sql = "INSERT INTO conferences(conferences,fid)
VALUES ('$conferences','$id')";
...
if ($rowadv['pagename']=='Add Conferences')
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Add  Conference Form</h4>
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                       ...
                       <form class="form" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i>Faculty Conference</h4>
                                <div class="row">
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
   ...
   echo "<option value='".$row['id']."''>".$row['fname']."</option>";
                              ...
                              <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Enter Conference <span style="color:red">*</span> </label>
                                            <input  style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white; border:1px solid #5B8343"  type="text" id="conferences" value="" autofocus="true" class="form-control" value="" name="conferences">
                                        </div>
 </div>
                    ...
                    <div  style="display: none" class="loader"></div>
                            ...
                            <div class="form-actions">
                                ...
                                <button  name="submit" style="background-color: #5B8343;color:white;border:1px solid #062F4F" type="submit" class="btn btn-outline-info ">
                                    <i class="fa fa-check"></i> Add Conference
                                </button>
                            </div>
                            </form>
