      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link" href="services.html"><b>Downloads</b></a>
          </li>
 <li class="nav-item">
...
<section class="w3l-about-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      ...
      <p><a href="index12.php">Home</a> &nbsp; / &nbsp; Objectives</p>
    </div>
  </div>
</section>
        ...
        <div class="container py-md-5">
            <div class="cwp4-two row">
                    ...
                    <div class="cwp4-text col-lg-8">
                        <h3 style="color:#1090CD; font-size:25px">Our Objectives</h3>
                        <h6 style="color:#5B8343">Welcome to CS&IT Department of WUBAJK</h6>
                    <p style="font-size:16px"><b>PEO 1:</b> We aim to produce graduates who will be able to apply computing knowledge and skills to design and develop effective solutions for complex real-life problems.<br>
<b>PEO 2:</b> We aim to produce women leaders who are empowered with the confidence, communication skills, and ethical values necessary to lead teams and organizations. Graduates will be prepared to navigate diverse professional environments and effect positive change.<br>
<b>PEO 3:</b> Our program will instill a culture of continuous learning and adaptability in graduates, enabling them to stay abreast of evolving technologies throughout their careers. <br>
<b>PEO 4:</b> Graduates will apply their knowledge and skills to contribute meaningfully to the economic and scientific development of the state of Azad Jammu and Kashmir and Pakistan.
