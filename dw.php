...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <meta name="description" content="School Management System developed by Pak Softwares. The system provides the best and easy solution to handle school matters including admissions, fees, accounts, examination, sms, website controls, portal controls and many more.">
    ...
    <title>Datewise Pending Installments</title>
...
if ($rowadv['pagename']=='Pending Installments')
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">DATEWISE PENDING INSTALLMENTS REPORT</h4>
            ...
            <form class="form" method="POST" action="dwpdf.php">
              <div class="form-body">
                <h4 class="form-section"><i class="fa fa-user"></i> Report Requirments</h4>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label style="color:black" for="userinput1">Select Date</label>
              ...
              <div class="form-actions ">
                 <button tyle="background-color: #ffd338;color:black
                       ; !important" type="submit"  id="save" class="btn btn-danger btn-min-width btn-glow mr-1 mb-1">
                  <i class="fa fa-check-square-o"></i> View DATEWISE PENDING INSTALLMENTS
                </button>
