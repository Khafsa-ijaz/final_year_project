...
$date = mysqli_real_escape_string($conn, $date);
     ...
     $sql = "INSERT INTO news(fname,file,txt,date)
VALUES ('$fname', '$file','$txt','$date')";
if ($conn->query($sql)===TRUE) {
  echo '<script type="text/javascript">';
  echo 'setTimeout(function () { swal("SUCCESS","News Uploaded Successfully!","success")';
  echo '}, 1000);</script>'; 
}
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color:  #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome to Add News Form</h4>
            ...
            <div class="s text-center " role="" aria-label="Basic example">   
                    ...
                    <div class="modal-content">
                      ...
                      <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                       ...
                       <form class="form" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i> News Info</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">File Name <span style="color:red">*</span> </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;border:1px solid #5B8343"  type="text" id="filename" autofocus="true" class="form-control" value="" name="fname">
                                        </div>
                                       ...
                                       <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Upload File <span style="color:red">  .png image only.</span>  </label>
             ...
             <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">TextNews  </label>
                                            <input s style="box-shadow: 0 0 4px #333D47;background-color: #1090CD;color:white;border:1px solid #5B8343"  type="text" id="txt" autofocus="true" class="form-control" value="" name="txt">
                                        </div>
                    ...
                    <div  style="display: none" class="loader"></div>
                            ...
                            <div class="form-actions">
                                ...
                                <button  name="submit" style="background-color: #5B8343;color:white;border:1px solid #062F4F" type="submit" class="btn btn-outline-info ">
                                    <i class="fa fa-check"></i> Add News
                                </button>
                            </div>
                            </form>
...
if (fname!='' )
{
 $.ajax({
                  type:'POST',
                    url: 'savefaculty.php',
                    dataType: 'json',
                    data: {filename:filename,file:file},
