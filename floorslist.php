...
if ($rowadv['pagename']=='View Floors')
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls"><b><u>Floors List</b></u> <i><u></i></u></b></h4>
                        ...
                        <table sty class="table table-striped table-bordered file-export">
                            <thead>
                                <tr>
                                      ...
                                      <th style="background-color:#304A7B;color: white ">FLOOR NAME</th>
