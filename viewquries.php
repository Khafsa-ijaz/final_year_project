...
include('navigation.php');
 ...
 <?php include('fourteen.php');
    ...
    ?>
        ...
        <li  class=" nav-item"><a href="#"><i class="icon-layers"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Setting</span></a>
            <ul class="menu-content">


   <?php
                $sqladv = "SELECT pagename,link FROM menu where category='Setting' and status='1' and user='$rowsession[username]'";
   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Quries</h4>
    ...
    <div class="row">
      ...
      <hr style="  border-top: 2px dotted #5B8343;">
                        <table style='width: 100%;' class="table table-striped table-bordered file-export">
                            <thead>
                                <tr>
                                   ...
                                   <th style="background-color:#1090CD;color: white  ">DATE</th>
                                      <th style="background-color:#1090CD;color: white "> NAME</th>
                                    <th style="background-color:#1090CD;color: white  ">EMAIL </th>
                                              <th style="background-color:#1090CD;color: white  ">QUERY</th>
            ...
            $sql = "SELECT * FROM enquiry where status='1' order by id DESC";
...
<td>
                             ...
                             <button data-toggle='tooltip' title='Delete Query' type='button' value=Delete id=".$row['id']." class='btn btn-icon btn-danger btn-sm cc'><i class='fa fa-trash'></i></button>
</td>
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Delete Query?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
