...
function Header()
{
   ...
   $this->SetTextColor(0,0,0);
    ...
    $this->Cell(160,10,'ALL EMPLOYEES LIST',0,0,'C');
...
function Footer()
{
  ...
  $this->Cell(30, 5, "KHAFSA_IJAZ & HABEEBA MATEEN", 0, 0,1);
}
}
$pdf = new PDF();
$pdf->AddPage('L');
...
$pdf->CellFitScale(15,6,$row['cnic'],1,0,'L');
...
$pdf->CellFitScale(58,6,$row['address'],1,0,'L',1);
 $pdf->CellFitScale(58,6,$row['cnic'],1,0,'L',1);
