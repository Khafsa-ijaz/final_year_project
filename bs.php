...
<section class="w3l-about-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>Programs</h2>
      <p><a href="index12.php">Home</a> &nbsp; / &nbsp;<a href="programs.php"> Programs</a> &nbsp; / &nbsp; Graduates</p>
    </div>
  </div>
</section>
        ...
        <div class="container py-md-5">
            <div class="cwp4-two row">
                ...
                <div class="cwp4-text col-lg-8">
                        <h3 style="color:#1090CD; font-size:30px">Master Of Science In Computer Science(MSCS)</h3>
                        <h5 style="color:#5B8343 ; font-weight:bold;">Introduction</h5>
                        
                         <p style="font-size:15px">  The Data Science Department serves as the nexus of modern analytics, where data becomes the catalyst for innovation and informed decision-making. Within our department, students immerse themselves in the realms of data mining, machine learning, and statistical analysis, honing skills vital for navigating today's data-driven landscape. Equipped with this expertise, graduates emerge poised to tackle complex challenges and drive transformative change across diverse industries.

                    </p>
                         <h5 style="color:#5B8343 ; font-weight:bold;">Objectives</h5>
                        
                         <p style="font-size:15px"> The MS (Computer Science) comprises of both course work as well as a research component. There are four ‘core courses’ aimed at strengthening the understanding and competence of students in computer science fundamentals. The University expects its MS graduates to pursue careers either as ‘Computer Science Faculty Members’ or as ‘Software Development Managers’ in the industry
                    </p>
                     <h5 style="color:#5B8343 ; font-weight:bold;">Eligibility criteria</h5>
                        
                         <p style="font-size:15px">   Degree in relevant subject, earned from a recognized university after 16 years of education with at least 60% marks or CGPA of at least 2.5 (on a scale of 4.0).• The university entrance test is mandatory.• Overall merit comprises of academic record and Entrance test result as per the following distribution and formula:
                            <ul>
                                <li>                    BSCS/ MCS:  35%
  </li>
  <li> Interview:  10%</li>
...
<tr>
<td colspan="3" bgcolor="#5B8343" style="text-align: center; color: white;"><strong>Semester I</strong></td>
</tr>
<tr>
<td>CS7101 

</td>
<td>Advanced Analysis of Algorithms
...
<tr>
<td colspan="3" bgcolor="#5B8343" style="text-align: center; color: white;"><strong>Semester II</strong></td>
</tr>
<tr>
<td>CS7201
...
<td>Advanced Computer Architecture
...
<tr>
<td colspan="3" bgcolor="#5B8343" style="text-align: center; color: white;"><strong>Semester III</strong></td>
</tr>
<tr>
<td>CS-8101
...
<tr>
<td colspan="3" bgcolor="#5B8343" style="text-align: center; color: white;"><strong>Semester IV</strong></td>
</tr>
<tr>
<td>CS-8101
