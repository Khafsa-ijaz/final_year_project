...
if ($rowadv['pagename']=='View Property No')
{
   ...
   echo "<li><a class='menu-item' href='$rowadv[link]' data-i18n='nav.vertical_nav.vertical_nav_fixed'>$rowadv[pagename]</a>
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #3EBBE5" class="card-header">
                  <h4 style="color:white" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Property No List</h4>
    ...
    <div class="row">
        <div class="col-12">
                            ...
                            <thead>
                                <tr>
                                   <th style="background-color:#304A7B;color: white ">S.#</th>
                                    ...
                                    <th style="background-color:#304A7B;color: white  ">Property No</th>
            ...
            $sql = "SELECT * FROM   propertyno  order by project ";
...
$(".cc").click(function(e) {
 ...
 swal({
  title: "Are You Sure to Delete Property No?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
