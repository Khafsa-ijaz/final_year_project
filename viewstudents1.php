		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color: #f9d140" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Students List</h4>
        ...
        <div class="col-12">
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                  ...
                  <div class="s text-center " role="" aria-label="Basic example">   <a target="_blank" href="studentslist"><button style="background-color: #304A7B;color: white !important" type="button" class="btn btn-outline-warning btn-sm btn-glow" >
                    Complete PDF
                  </button>
</a>

<a target="_blank" href="activestudentslist"><button  type="button" class="btn btn-success btn-sm btn-glow" data-toggle="modal" data-target="#flipInY">
                    Active Students PDF
                  </button></a>



<a target="_blank" href="inactivestudentslist"><button  type="button" class="btn btn-danger btn-sm btn-glow" data-toggle="modal" data-target="#flipInY">
                    In-Active Students PDF
                  </button></a>
