   ...
   <li style='background-color: #304A7B' class=" nav-item"><a href="#"><i class="icon-layers"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Attendance</span></a>
		...
		<div class="col-md-12">
	        <div class="card">
              ...
              <div style="background-color:#5B8343" class="card-header">
                  <h4 style="color:black" class="card-title" id="horz-layout-colored-controls">Welcome You Are Viewing Employees List</h4>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div   class="card">
                ...
                <div class="card-content collapse show">
                  ...
                  <div class="s text-center " role="" aria-label="Basic example">   <!-- <button style="background-color: #5B8343;color: white !important" type="button" class="btn btn-outline-warning btn-sm btn-glow" data-toggle="modal" data-target="#flipInY">
                    Complete PDF
                  </button> -->
      ...
      <hr style="  border-top: 2px dotted #5B8343">
                                       ...
                                       <th style="background-color:#f9d140;color: black  ">Actions</th>
                                         <th style="background-color:#304A7B;color: white  ">Address</th>
                                           <th style="background-color:#304A7B;color: white  ">Birth Date</th>
                                             <th style="background-color:#304A7B;color: white  ">Join Date</th>
                                                   <th style="background-color:#304A7B;color: white  ">Qualification</th>
                                                         <th style="background-color:#304A7B;color: white  ">Department</th>
                                                           
                                                                     <th style="background-color:#304A7B;color: white  ">Salary</th>
                                                                         <th style="background-color:#304A7B;color: white  ">Nic</th>
                                                                             <th style="background-color:#304A7B;color: white  ">ECON-1</th>
                                                                                     <th style="background-color:#304A7B;color: white  ">ECON-2</th>
                                                                                             <th style="background-color:#304A7B;color: white  ">ECON-3</th>
                                                                                                     <th style="background-color:#304A7B;color: white  ">ECON-4</th>
                                                                                                             <th style="background-color:#304A7B;color: white  ">Marital Status</th>
            ...
            $sql = "SELECT id,name,fname,designation,image,mob,salary,status FROM employees order by id DESC";
...
$image=$row['image'];
 ...
 <a target='_blank' data-toggle='tooltip' title='Print Employee Information' href=employeeinformation.php?id=".$row['id']."> <button type='button' class='btn btn-icon btn-dark btn-sm'><i class='fa fa-print'></i></button></a>
   ...
   <a target='_blank' data-toggle='tooltip' title='Send Whatsapp Msg' href=https://api.WhatsApp.com/send?phone=".$row['mob']."> <button type='button' class='btn btn-icon btn-success btn-sm'><i class='fa fa-whatsapp'></i></button></a>


<a data-toggle='tooltip' title='Upload Eemployee Picture' href=addepic.php?id=".$row['id']."> <button type='button' class='btn btn-icon btn-info btn-sm'><i class='fa fa-picture-o'></i></button></a>
  <a target='_blank' data-toggle='tooltip' title='Print ID Card' href=employeeidcard.php?id=".$row['id']."><button type='button' class='btn btn-icon btn-primary btn-sm'><i class='fa fa-id-card-o'></i></button></a>

 <a target='_blank' data-toggle='tooltip' title='Add Salary Details' href=salarydetails.php?id=".$row['id']."> <button type='button' class='btn btn-icon btn-info btn-sm'><i class='fa fa-money'></i></button></a>
...
dom: '<"top"i>rt<"bottom"flp>',
...

  {
    ...
    messageTop: 'Employees List List'
