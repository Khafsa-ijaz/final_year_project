...
else
{
    ...
    <div class="col-md-12">
          <div class="card">
              ...
              <div style="background-color: #5B8343" class="card-header">
                ...
                <h4 style='color:white' class="card-title">Assign menu Username <b><u><?php echo $id2?></b></u> <b><i style="color:red"></i><u></u></b></h4>
                                ...
                                <tr>
                                   <th style="background-color:#1090CD;color: white ">S.#</th>
                                      <th style="background-color:#1090CD;color: white ">Code</th>
                                       ...
                                       <th style="background-color:#1090CD;color: white ">WebPage</th>
                                        <th style="background-color:#1090CD;color: white ">Category</th>
  ...
  $count=0;
            include('connection.php');
$sql6 = "SELECT * FROM menu where user='$id2' order by category ASC";
 ...
 <option  value='0'> Hide </option>
  <option value='1'> Show </option>
           ...
           ?>
                 ...
                 <p align="center"><button type="submit" class="btn btn-info-outline "style="background-color: #5B8343; color:white; font-weight: bold;" name="save">Assign Roles</button></p>
              </form>
            </div>
        </div>
    </div>
